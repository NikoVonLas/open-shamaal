...
if (isset($zzadmin)) {
    ...
    $zzadmin = SQL_escape($zzadmin);
    $SQL = "select admin,id,name,decodepwd from sw_users where up_login=upper('{$zzadmin}') and admin > 0";
...
function weather()
{
    ...
    print "<div align=center> |<a href=bvgfvf7w83hr129jr1aw.php?load=$load&do=add>Добавить</a>| </div>";
    $timename[11]= "Полдень";
    $timename[12]= "Полдень";
    $timename[13]= "День";
    $timename[14]= "День";
    ...
    $timename[1]= "Ночь";
    $timename[2]= "Ночь";
    $timename[3]= "Время мёртвого сна";
    $timename[4]= "Время мёртвого сна";
    $timename[5]= "Восход";
    $timename[6]= "Восход";
    $timename[7]= "Раннее утро";
    $timename[8]= "Раннее утро";
    $timename[9]= "Утро";
    $timename[10]= "Утро";
    ...
    if ($do == 'add') {
        print "<tr bgcolor=EDF0F0><form action=bvgfvf7w83hr129jr1aw.php method=post><input type=hidden name=load value=$load><input type=hidden name=id value=$id><input type=hidden name=do value=new>";
    ...
    while ($row_num) {
        ...
        $typ1 = $row_num[5];
        $typ2 = $row_num[6];
        print "<tr bgcolor=EDF0F0><form action=bvgfvf7w83hr129jr1aw.php method=post><input type=hidden name=load value=$load><input type=hidden name=id value=$id><input type=hidden name=do value=save>";
        ...
        print "<td align=center><input type=submit value=Сохранить><br><br><a href=bvgfvf7w83hr129jr1aw.php?load=$load&do=del&id=$id>Удалить</a></td>";
        print "</form></tr>";
        $row_num=SQL_next_num();
    }
    if ($result) {
...
function antiteleport()
{
    ...
    print "<form action=bvgfvf7w83hr129jr1aw.php>";
    ...
    while ($row_num) {
        ...
        $anti_end = $row_num[2];
        print "<tr><td>$i</td><td>$anti_start</td><td>$anti_end</td><td><a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=del&anti_id=$anti_id><b>Удалить</b></a></td></tr>";
        $row_num=SQL_next_num();
    }
    if ($result) {
        SQL_free_result($result);
...
function makeobj()
{
    ...
    print "<div align=center>| <a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=add>Добавить свиток</a> |</div><br>";
    ...
    for ($i=0;$i<$count;$i=$i+10) {
        ...
        if ($i == $page) {
            ...
            $p .= "|<a href=bvgfvf7w83hr129jr1aw.php?load=$load&page=$i class=menu>$i-$e</a>|";
        }
    }
...
function ipsearch()
{
    ...
    for ($i=0;$i<$count;$i=$i+30) {
        ...
        if ($i == $page) {
            ...
            $p .= "|<a href=bvgfvf7w83hr129jr1aw.php?load=$load&page=$i&ip_adress=$ip_adress&enter=$enter class=menu>$i-$e</a>|";
        }
    }
    ...
    if ($enter == 1) {
        ...
        while ($row_num) {
            ...
            $ip=$row_num[2];
            $reg_ip=$row_num[3];
            $pod .= "<tr><td class=small align=center>$level</td><td class=small><a href=bvgfvf7w83hr129jr1aw.php?load=3&name=$name>$name</a></td><td class=small align=center>$ip</td><td class=small align=center>$reg_ip</td></tr>";
            $row_num=SQL_next_num();
        }
        if ($result) {
            SQL_free_result($result);
        ...
        while ($row_num) {
            ...
            $ip2=$row_num[5];
            $ip3=$row_num[6];
            $pod .= "<tr><td class=small align=center>$dat<br>$tim</td><td class=small><a href=bvgfvf7w83hr129jr1aw.php?load=3&name=$name>$name</a></td><td class=small align=center>$ip</td><td class=small align=center>$ip2<br>$ip3</td></tr>";
            $row_num=SQL_next_num();
        }
        if ($result) {
            SQL_free_result($result);
...
function arena()
{
    ...
    print "<div align=center><a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=add>Добавить арену</a></div>";
    ...
    if ($action == "add") {
        ...
        <form action=bvgfvf7w83hr129jr1aw.php method=post><input type=hidden name=load value=$load><input type=hidden name=id value=$id> <input type=hidden name=action value=new>
    ...
    while ($row_num) {
        ...
        print "
        <tr bgcolor=DDE0E0><td align=center><table>
        <form action=bvgfvf7w83hr129jr1aw.php method=post><input type=hidden name=load value=$load><input type=hidden name=id value=$id> <input type=hidden name=action value=save>
...
function inf()
{
    ...
    if ($cango == 1) {
        $tx = "<a href=bvgfvf7w83hr129jr1aw.php?load=$load&do=open><b><font color=red>Доступ закрыт</font></a>";
    } else {
        $tx = "<a href=bvgfvf7w83hr129jr1aw.php?load=$load&do=close><b><font color=green>Доступ открыт</font></a>";
    }
    print "<table cellspacing=1 bgcolor=768E92 align=center width=90% cellpadding=3>
        ...
        <tr bgcolor=DDE0E0><form action=bvgfvf7w83hr129jr1aw.php><input type=hidden name=load value=$load><input type=hidden name=do value=online><td width=50% ><b>Ограничение в игре</b></td><td align=right bgcolor=EFF3F7><input type=text name=mx_online size=4 maxlength=4 value='$max_online'>&nbsp;<input type=submit value=Поменять></td></form></tr>
        <tr bgcolor=DDE0E0><form action=bvgfvf7w83hr129jr1aw.php><input type=hidden name=load value=$load><input type=hidden name=do value=min_admin_lv><td width=50% ><b>Минимальный Админ ур. для входа</b></td><td align=right bgcolor=EFF3F7><input type=text name=mn_admin size=4 maxlength=4 value='$min_admin'>&nbsp;<input type=submit value=Поменять></td></form></tr>
        <tr bgcolor=DDE0E0><td width=50%><b>Доступ в игру</b></td><td align=right bgcolor=EFF3F7>$tx | <a href=bvgfvf7w83hr129jr1aw.php?load=$load&do=kick><b>Выгнать</b></a></td></tr>
...
function map()
{
    ...
    print "<div align=center>| <a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=add&start_page=$start_page&id_from=$id_from&id_end=$id_end&showin=$showin&show_name=$show_name>Добавить комнату</a> |</div><br>";
    $where = '';
    if ($showin <> 0) {
    ...
    for ($i=0;$i<=$num;$i=$i+10) {
        ...
        if ($i == $start_page) {
            ...
            $go = $go."<a href=bvgfvf7w83hr129jr1aw.php?load=$load&start_page=$i&id_from=$id_from&id_end=$id_end&showin=$showin&show_name=$show_name><font size=1>|$m-$e|</font></a>";
        }
    }
        ...
        print "<form action=bvgfvf7w83hr129jr1aw.php method=post><input type=hidden name=start_page value=$start_page><input type=hidden name=show_name value=$show_name><input type=hidden name=id_end value=$id_end><input type=hidden name=id_from value=$id_from><input type=hidden name=showin value=$showin><input type=hidden name=load value=$load><input type=hidden name=action value=new><tr bgcolor=EFF3F7><td align=center></td>
                ...
                <td align=center>
                    ...
                    <table align=center width=100%>
                        ...
                        <tr>
                            <td colspan=2><table cellpadding=3 cellspacing=0 width=95%><tr><td width=50>Локация:</td><td width=100>$optend</td><td width=100%></td><td><a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=del&map_id=$m_id>Удалить</td><td><input type=submit value=Сохранить></td></tr></table></td>
                        </tr>
                    </table>
                </td></tr></form>";
    }
...
function location()
{
    ...
    print "<div align=center>| <a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=add>Добавить локацию</a> |</div><br>";
    ...
    if ($action == 'add') {
        ...
        print "<form action=bvgfvf7w83hr129jr1aw.php method=post><input type=hidden name=load value=$load><input type=hidden name=action value=new><tr bgcolor=EDF1F1><td width=150 align=center><input type=text name=loc_name value=''></td><td width=150 align=center>$optend</td><td align=center><a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=del&loc_id=$l_id>&nbsp;</a></td><td align=center><input type=submit value=Создать></td></tr></form>";
    }
    ...
    while ($row_num) {
        ...
        print "<form action=bvgfvf7w83hr129jr1aw.php method=post><input type=hidden name=load value=$load><input type=hidden name=action value=save><input type=hidden name=loc_id value=$l_id><tr bgcolor=EDF1F1><td width=150 align=center><input type=text name=loc_name value='$l_name'></td><td width=150 align=center>$optend</td><td align=center><a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=del&loc_id=$l_id>Удалить</a></td><td align=center><input type=submit value=Сохранить></td></tr></form>";
        $row_num=SQL_next_num();
    }
    if ($result) {
        SQL_free_result($result);
...
function stuff()
{
    ...
    $shab_specif = "<select name=search_specif><option value=-1>Любой</option><option value=0 sp0>Одежда</option><option value=1 sp1>Маг. свитки</option><option value=2  sp2>Пища</option><option value=3  sp3>Руда</option><option value=4  sp4>Растение</option><option value=5  sp5>Эликсиры</option><option value=6  sp6>Кланы</option><option value=7  sp7>Свитки</option><option value=8  sp8>Руны</option><option value=9  sp9>Телепорты</option><option value=10  sp10>Склад игрока</option><option value=11  sp11>Дерево</option><option value=12  sp12>Усып Игрока</option><option value=13  sp13>Магазин</option><option value=14  sp14>Усып клана</option><option value=15  sp15>Резиденция</option><option value=16  sp16>Склад</option><option value=17  sp17>Кузница</option><option value=18  sp18>Ювелирная</option><option value=19  sp19>Лаборатория</option><option value=20  sp20>Ателье</option><option value=21  sp21>Мастерская</option><option value=22  sp22>Сено</option><option value=23  sp23>Подарки</option><option value=24  sp24>Конюшня</option><option value=25  sp25>Новый год</option><option value=26  sp26>Пдр. свитки</option></select>";
    $shab_specif2 = "<select name=specif><option value=0 sp0>Одежда</option><option value=1 sp1>Маг. свитки</option><option value=2  sp2>Пища</option><option value=3  sp3>Руда</option><option value=4  sp4>Растение</option><option value=5  sp5>Эликсиры</option><option value=6  sp6>Кланы</option><option value=7  sp7>Свитки</option><option value=8  sp8>Руны</option><option value=9  sp9>Телепорты</option><option value=10  sp10>Склад игрока</option><option value=11  sp11>Дерево</option><option value=12  sp12>Усып Игрока</option><option value=13  sp13>Магазин</option><option value=14  sp14>Усып клана</option><option value=15  sp15>Резиденция</option><option value=16  sp16>Склад</option><option value=17  sp17>Кузница</option><option value=18  sp18>Ювелирная</option><option value=19  sp19>Лаборатория</option><option value=20  sp20>Ателье</option><option value=21  sp21>Мастерская</option><option value=22  sp22>Сено</option><option value=23  sp23>Подарки</option><option value=24  sp24>Конюшня</option><option value=25  sp25>Новый год</option><option value=26  sp26>Пдр. свитки</option></select>";
    ...
    $top_name = "<input name='search_name' value='$search_name' />";
    $top_level = "<input name='search_level' value='$search_level' />";
    ...
    print "<table width=100% cellspacing=1 bgcolor=768E92 cellpadding=1>
            <form action=bvgfvf7w83hr129jr1aw.php method=post>
                ...
                <tr bgcolor=EFF3F7>
                    ...
                    <td align='center'>
                        <input type=submit value=Ввод style='width:45px;'>
                    </td>
                </tr>
            </form>
           </table><br>";
    print "<div align=center><a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=$action&search_place=$search_place&search_typ=$search_typ&search_specif=$search_specif&search_name=$search_name&search_level=$search_level&page=$page&action=add class=menu>Добавить</a></div>";
    $sear = "";
    if ($search_place > -1) {
    ...
    if ($search_level != '') {
        $sear .= " and level=$search_level";
    }
    if ($search_name != '') {
        $sear .= " and name like '%$search_name%'";
    }
    if ($sear <> "") {
    ...
    for ($i=0;$i<$count;$i=$i+10) {
        ...
        if ($i == $page) {
            ...
            $p .= "|<a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=$action&search_place=$search_place&search_typ=$search_typ&search_specif=$search_specif&search_name=$search_name&search_level=$search_level&page=$i class=menu>$i-$e</a>| ";
        }
    }
...
function city()
{
    ...
    print "<div align=center>| <a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=add>Добавить город</a> |</div><br>";
    if ($action == 'save') {
    ...
    while ($row_num) {
        ...
        print "<form action=bvgfvf7w83hr129jr1aw.php method=post><input type=hidden name=city_id value=$city_id><input type=hidden name=action value=save><input type=hidden name=load value=6><tr bgcolor=EFF3F>
            <td align=center>
                $city_id
            </td>
            <td align=center>
            ...
            <td align=center>
                <a href=bvgfvf7w83hr129jr1aw.php?load=6&city_id=$city_id&action=del><b>Удалить</b></a>
            </td>
            <td align=center>
...
function clan()
{
    ...
    print "<div align=center>| <a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=add>Добавить клан</a> |</div><br>";
    ...
    while ($row_num) {
        ...
        print "<form action=bvgfvf7w83hr129jr1aw.php method=post><input type=hidden name=city_id value=$city_id><input type=hidden name=action value=save><input type=hidden name=load value=$load><tr bgcolor=EFF3F>
        <td align=center>
            $city_id
        </td>
        <td align=center>
        ...
        <td align=center>
            <a href=bvgfvf7w83hr129jr1aw.php?load=$load&city_id=$city_id&action=del><b>Удалить</b></a>
        </td>
        <td align=center>
        <input type=submit value=Изменить>
        </td>
...
function editobj($owner, $room)
{
    ...
    print "<br><table width=100% bgcolor=768E92 cellspacing=1><tr bgcolor=DFE3E7><td align=center colspan=2><b>Объекты (<a href=bvgfvf7w83hr129jr1aw.php?load=$load&name=$pl_name&do=add&action=$action&sid=$sid&show_obj=1&page=$page>Добавить</a>)</b></td></tr>";
    if ($do == "add") {
        $sp = -1;
        $pl=-1;
        ...
        $select .= "</select>";
        $info = "<table cellpadding=2 cellspacing=2><form action=bvgfvf7w83hr129jr1aw.php method=post>
...
<tr><td>Вампиризм</td><td><input type=text name=drain_attack value='$drain_attack' size=3 maxlength=3></td></tr>
            ...
            <tr><td>Одет</td><td>$on".($active == 1 ? " [<a href=\"bvgfvf7w83hr129jr1aw.php?load=$load&id=$id&do=unwearitem&name=$pl_name&action=$action&sid=$sid&show_obj=1\">Снять</a>]" : "")."</td></tr>
...
function mapobj()
{
    ...
    if ($action == "showobj") {
        print "<div align=center><a href=bvgfvf7w83hr129jr1aw.php?load=$load&page=$page>Назад</a></div>";
        editobj($sid, 1);
    } else {
        print "<div align=center><a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=nadd&page=$page>Добавить</a></div>";
        ...
        for ($i=0;$i<$count;$i=$i+15) {
            ...
            if ($i == $page) {
                ...
                $p .= "|<a href=bvgfvf7w83hr129jr1aw.php?load=$load&page=$i class=menu2>$i-$e</a>|";
            }
        }
        ...
        while ($row_num) {
            ...
            if (($what == "buy") || ($what == "get")) {
                $op3 = "<input type=button value=Вещи style='width:90' onclick='document.location=\"bvgfvf7w83hr129jr1aw.php?load=$load&action=showobj&sid=$id\";'><br>";
            } else {
                $op3 = "";
            }
            $op4 = "";
...
function logs()
{
    ...
    $com_text = "<table><form action=bvgfvf7w83hr129jr1aw.php method=post><input type=hidden name=load value=$load><input type=hidden name=name value=$pl_name><tr>";
    ...
    while ($row_num) {
        ...
        $pod .= "<tr><td class=small>$dat</td><td class=small align=center><a href=bvgfvf7w83hr129jr1aw.php?load=3&name=$name2>$name2</a></td><td class=small align=center><a href=bvgfvf7w83hr129jr1aw.php?load=3&name=$name>$name</a></td><td class=small align=center>$num</td><td class=small align=center>$lvl</td></tr>";
        $row_num=SQL_next_num();
    }
    if ($result) {
        SQL_free_result($result);
    ...
    if (isset($name)) {
        ...
        if ($chat_banTime > 0) {
            if ($chat_banFor <> "") {
                ...
                $text = "Бан чата на $t по причине: `$chat_banFor`";
                $chat_banFor = checkletter($text);
                $time = date("Y-m-d H:i");
                if ($admin_name != "") {
                    $SQL="update sw_users set admin_text=CONCAT(COALESCE (admin_text, ' '),'<font color=red>$time [$admin_name]: $chat_banFor.</font><br>'),ban_chat=$chat_banTime where up_name='$name'";
                    SQL_do($SQL);
                }
            }
        }
        ...
        if ($ban_time > 0) {
            if ($ban_for <> "") {
                ...
                $text = "Бан на $t по причине: `$ban_for`";
                $ban_for = checkletter($text);
                $time = date("Y-m-d H:i");
                if ($admin_name != "") {
                    $SQL="update sw_users set admin_text=CONCAT(COALESCE (admin_text, ' '),'<font color=red>$time [$admin_name]: $ban_for.</font><br>'),ban=$ban_time,ban_for='$ban_for' where up_name='$name'";
                    SQL_do($SQL);
                }
            }
        }
        $SQL="select id,chp,cmana,name,pic,sex,race,str,dex,intt,wis,con,h_up,exp,level,gold,bank_gold,s_up,city,city_rank,city_pay,city_text,online,ban,ban_for,admin_text,reg_ip,ip,admin,reg_date,city,clan,pack,city_rank,clan_rank, ban_chat, mail , skill_down, up_login, room, resp_room, h_down from sw_users where up_name='$name'";
        $row_num=SQL_query_num($SQL);
        while ($row_num) {
            $pl_id = $row_num[0];
            $pl_chp = $row_num[1];
            ...
            $ban_chat = $row_num[35];
            $pl_mail = $row_num[36];
            $pl_skilldown = $row_num[37];
            $pl_login = $row_num[38];
            $pl_room = $row_num[39];
            $pl_resp_room = $row_num[40];
            $pl_hdown = $row_num[41];
            $row_num=SQL_next_num();
        }
        if ($result) {
        ...
        if ($pl_name <> '') {
            ...
            while ($row_num) {
                ...
                $clon .= "<tr><td class=small><a href=bvgfvf7w83hr129jr1aw.php?load=3&name=$name>$name</a></td><td class=small align=right>$on2</td></tr>";
                $row_num=SQL_next_num();
            }
            if ($result) {
                SQL_free_result($result);
            ...
            if ($admin_lvl == 1 || $admin_lvl == 5) {
                print "<tr bgcolor=DEE2E>
                                        <td width=150>Логин (ID):</td><td>$pl_login ($pl_id)</td>
                                    </tr>
                                    <tr bgcolor=DEE2E>
                                    ...
                                    <tr bgcolor=DEE2E>
                                        <td width=150><b>Текущая локация:</b></td><td><input type=text name=pl_room value='$pl_room' size=6></td>
                                    </tr>
                                    <tr bgcolor=DEE2E>
                                        <td width=150><b>Локация респа:</b></td><td><input type=text name=pl_resp_room value='$pl_resp_room' size=6></td>
                                    </tr>
                                    <tr bgcolor=DEE2E>
                ...
                print "<tr bgcolor=DEE2E>
                                    ...
                                    <tr bgcolor=DEE2E>
                                        <td width=150><b>Сбросов:</b></td><td><input type=text name=pl_skilldown value='$pl_skilldown' size=3></td>
                                    </tr>
                                    <tr bgcolor=DEE2E>
                                        <td width=150><b>Сбросов характеристик:</b></td><td><input type=text name=pl_hdown value='$pl_hdown' size=3></td>
                                    </tr>
                                    <tr bgcolor=DEE2E>
            ...
            if ($admin_lvl != 1) {
                $chat_snt = "(max:12 часов)";
            }
            print "<tr bgcolor=CED2D>
            ...
            if ($show_obj <> 1 && ($admin_lvl == 1 || $admin_lvl == 5)) {
                print "
                    <tr>
                    <form action=bvgfvf7w83hr129jr1aw.php method=post><input type=hidden name=load value=$load><input type=hidden name=name value=$pl_name><input type=hidden name=action value=history>
                    <td colspan=2 class=small bgcolor=DEE2E>
                    Записки модератора:<br><br><div style=unicode-bidi:embed;font-family:monospace;white-space:pre;>$admin_text</div> <br><table cellpadding=2 cellspacing=0><tr><td class=small>Добавить:</td><td><input type=text name=admin_text size=45 maxlength=255></td><td><input type=submit value=» style='width:20'></td></tr></table></td>
                    </form>
                    </tr>";
                ...
                if ($admin_lvl == 1) {
                    if ($count > 0) {
                        ...
                        while ($row_num) {
                            ...
                            $var_name=$row_num[1];
                            $var_value=$row_num[2];
                            print "<tr><td class=small width=250>$var_name</td><td class=small>$var_value</td><td class=small  align=right><a href=bvgfvf7w83hr129jr1aw.php?load=$load&name=$pl_name&skill=$id&do=rsvar>Сбросить</a></td></tr>";
                            $row_num=SQL_next_num();
                        }
                        if ($result) {
                            SQL_free_result($result);
                        ...
                        print "</table><a href=bvgfvf7w83hr129jr1aw.php?load=$load&name=$pl_name&do=rvar class=small>&nbsp;» Сбросить переменные</a></td></tr>";
                    }
                    ...
                    while ($row_num) {
                        ...
                        $sid=$row_num[3];
                        print "<tr><td class=small  width=250>$sname</td><td class=small>$spercent / $spercent_max</td><td class=small align=right><a href=bvgfvf7w83hr129jr1aw.php?load=$load&name=$pl_name&skill=$sid&do=rs>Сбросить</a></td></tr>";
                        $row_num=SQL_next_num();
                    }
                    if ($result) {
                        SQL_free_result($result);
                    }
                    print "</table><a href=bvgfvf7w83hr129jr1aw.php?load=$load&name=$pl_name&do=rsall class=small>&nbsp;» Сбросить все умения</a></td></tr>";
                }
                ...
                if ($admin_lvl == 1) {
                    ...
                    if ($count <> 0) {
                        ...
                        for ($i=0;$i<$count;$i=$i+5) {
                            ...
                            if ($i == $tradepage) {
                                ...
                                $p .= "|<a href=bvgfvf7w83hr129jr1aw.php?tradepage=$i&name=$pl_name&load=$load>$i-$e</a>|";
                            }
                        }
                        ...
                        while ($row_num) {
                            ...
                            print "<tr bgcolor=DEE2E><td colspan=2 align=center><table width=100%><tr><td width=100 valign=top class=small>$dat</td><td width=250 valign=top>$pl1_name | <a href=bvgfvf7w83hr129jr1aw.php?load=17&ip_adress=$pl1_ip>$pl1_ip1</a><br><font class=ssmall>$mt</font></td><td  valign=top width=250>$pl2_name | <a href=bvgfvf7w83hr129jr1aw.php?load=17&ip_adress=$pl2_ip>$pl2_ip2</a><br><font class=ssmall>$ht</font></td></tr></table></td></tr>";
                            $row_num=SQL_next_num();
                        }
                        if ($result) {
                            SQL_free_result($result);
                    ...
                    $com_text = "$com_text </select>&nbsp;</td><td><input type=submit value=Показать></td><td><a href=bvgfvf7w83hr129jr1aw.php?load=$load&name=$pl_name class=small>[Последнии 10]</a></td>";
                    ...
                    while ($row_num) {
                        ...
                        $tim=$row_num[1];
                        $ip=$row_num[2];
                        print "<tr><td class=small>$dat</td><td class=small>$tim</td><td class=small><a href=bvgfvf7w83hr129jr1aw.php?load=17&ip_adress=$ip>$ip</a></td></tr>";
                        $row_num=SQL_next_num();
                    }
                    if ($result) {
                        SQL_free_result($result);
            ...
            if ($show_obj == 1) {
                ...
                if ($admin_lvl == 1) {
                    print "<div align=center><a href=bvgfvf7w83hr129jr1aw.php?load=$load&show_obj=1&name=$pl_name>Показать объекты</a></dic>";
                }
            }
        }
    } else {
...
function golos()
{
    ...
    for ($i=0;$i<=$num;$i=$i+5) {
        ...
        if ($i == $start_page) {
            ...
            $go = $go."<a href=bvgfvf7w83hr129jr1aw.php?load=$load&page=$i><font size=1>|$m-$e|</font></a>";
        }
    }
    print "<br><div align=center>$go</div>";


    print "<div align=center><br>| <a href=bvgfvf7w83hr129jr1aw.php?load=2&page=$page&action=addnew>Добавить голосование</a> | <br><br></div>";
    if ($action == 'saveVote') {
    ...
    if ($action == 'addnew') {
        print "<form action=bvgfvf7w83hr129jr1aw.php method=post><table>
        <input type=hidden name=load value=$load>
    ...
    foreach ($sqlRes as $row) {
        ...
        if ($active == 1) {
            ...
            $s = "<a href=bvgfvf7w83hr129jr1aw.php?load=$load&page=$page&action=ac&idVote=$id><b><font color=red>Неактивно</font></b></a>";
        }

        if (isset($id)) {
            print "<table>
            <tr><td>#$id Вопрос: </td><td><form action=bvgfvf7w83hr129jr1aw.php method=post>
            <input type=hidden name=page value=$page>
            <input type=hidden name=load value=$load>
...
function kvest()
{
    ...
    $gv_pet = "<select name=|NAME| style=width:170><option value=0>Пусто</option>";
    $SQL="select id,name from sw_pettype order by name";
    $row_num=SQL_query_num($SQL);
    while ($row_num) {
        $petid = $row_num[0];
        $petname = $row_num[1];
        $gv_pet .= "<option value=$petid petse$petid> - $petname</option>";
        $row_num=SQL_next_num();
    }
    if ($result) {
        SQL_free_result($result);
    ...
    print "<script>
        ...
        function myreplacepet(name,pat)
        {
            var pattern = /\|NAME\|/ig;
            myStringPet2 = myStringPet.replace(pattern,name);
            myStringPet2 = myStringPet2.replace(pat,'selected');
            return myStringPet2;
        }
    ...
    $i = 0;
    $SQL="select id,name from sw_object where what='kvest' order by id";
    $row_num=SQL_query_num($SQL);
    while ($row_num) {
        $i++;
        $fid[$i] = $row_num[0];
    ...
    for ($k = 1; $k <= $i; $k++) {
        if ($k == $show) {
            ...
            $p .= "&nbsp;<a href=bvgfvf7w83hr129jr1aw.php?load=$load&show=$k>$fid[$k]</a> ";
        }
    }
    ...
    <tr><td colspan=2 align=center bgcolor=DFE3E2><a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=add&show=$show><b>Добавить разговор</b></a></td></tr><tr><td colspan=2 align=center bgcolor=DFE3E2>";
    ...
    if ($action == "add") {
        ...
        print "<table width=90% align=center cellspacing=1 bgcolor=768E92>
            ...
            <tr bgcolor=E7ECEB><td bgcolor=E8EDEC width=150>Ежедневный:</td><td><input type=checkbox name=is_daily /></td></tr>
            ...
            <tr bgcolor=E7ECEB><td bgcolor=E8EDEC width=150>Взять животное:</td><td><script>document.write(myreplacepet('get_pettype',/petse$get_pettype/ig));</script> <input type=text name=get_petcount value='0' size=3 maxlength=3></td></tr>
            <tr bgcolor=E7ECEB><td bgcolor=E8EDEC width=150>Дать животное:</td><td><script>document.write(myreplacepet('give_pettype',/petse$give_pettype/ig));</script> <input type=text name=give_petcount value='0' size=3 maxlength=3></td></tr>
    ...
    if ($action == "new") {
        $SQL="INSERT INTO sw_kvest (text,give_exp,give_money,give_room,give_obj,give_objnum,get_obj,get_objnum,fid,var_name,var_value,need_var_name,need_var_value, give_pettype, give_petcount, get_pettype, get_petcount, is_daily) values ('$kv_talk_text',$give_exp,$give_money,$give_room,$give_obj,$give_objnum,$get_obj,$get_objnum,$fid[$show],'$var',$var_value,'$need_var',$need_var_value, '$give_pettype', '$give_petcount', '$get_pettype', '$get_petcount', ".($is_daily ? 'true' : 'false').")";
        SQL_do($SQL);
    }
    if ($action == "newans") {
        $SQL="INSERT INTO sw_kvest_ans (text,need_level,need_gold,need_obj,need_objnum,parent,var_name,var_value,need_pettype,need_petcount,is_daily) values ('$kv_talk_ans_text',$need_level,$need_gold,$need_obj,$need_objnum,$parent,'$var',$var_value,$need_pettype,$need_petcount,".($is_daily_ans ? 'true' : 'false').")";
        SQL_do($SQL);
    }
    if ($action == "save") {
        $SQL="update sw_kvest set text='$kv_talk_text',give_exp=$give_exp,give_money=$give_money,give_room=$give_room,give_obj=$give_obj,give_objnum=$give_objnum,get_obj=$get_obj,get_objnum=$get_objnum,var_name='$var',var_value=$var_value,need_var_name='$need_var',need_var_value=$need_var_value, give_pettype='$give_pettype', give_petcount='$give_petcount', get_pettype='$get_pettype', get_petcount='$get_petcount', is_daily=".($is_daily ? 'true' : 'false')." where id=$id";
        SQL_do($SQL);
        //print "$SQL";
    }
    if ($action == "del") {
    ...
    if ($action == "saveans") {
        $SQL="update sw_kvest_ans set text='$kv_talk_ans_text',need_level=$need_level,need_gold=$need_gold,need_obj=$need_obj,need_objnum=$need_objnum,goto=$kv_talk_ans_goto,var_name='$var',var_value=$var_value,need_pettype=$need_pettype,need_petcount=$need_petcount, is_daily=".($is_daily_ans ? 'true' : 'false')." where id=$id";
        SQL_do($SQL);
    }
    if ($action == "delans") {
    ...
    while ($row_num) {
        ...
        $give_pettype = $row_num[22];
        $give_petcount = $row_num[23];
        $get_pettype = $row_num[24];
        $get_petcount = $row_num[25];
        ...
        $petgiv = str_replace("petse$give_pettype", "selected", $gv_pet);
        $petgiv = str_replace("|NAME|", "give_pettype", $petgiv);
        $petget = str_replace("petse$get_pettype", "selected", $gv_pet);
        $petget = str_replace("|NAME|", "get_pettype", $petget);
        $petned = str_replace("petse$need_pettype", "selected", $gv_pet);
        $petned = str_replace("|NAME|", "need_pettype", $petned);
        $petned2 = str_replace("petse0", "selected", $gv_pet);
        $petned2 = str_replace("|NAME|", "need_pettype", $petned2);
        ...
        if ($last <> $kv_talk_id) {
            ...
            <tr bgcolor=E7ECEB><td bgcolor=E8EDEC width=150>Ежедневный:</td><td><input type=checkbox name=is_daily ".($is_daily ? "checked" : "")."/></td></tr>
            ...
            <tr bgcolor=E7ECEB><td bgcolor=E8EDEC width=150>Взять животное:</td><td><script>document.write(myreplacepet('get_pettype',/petse$get_pettype/ig));</script> <input type=text name=get_petcount value='$get_petcount' size=3 maxlength=3></td></tr>
            <tr bgcolor=E7ECEB><td bgcolor=E8EDEC width=150>Дать животное:</td><td><script>document.write(myreplacepet('give_pettype',/petse$give_pettype/ig));</script> <input type=text name=give_petcount value='$give_petcount' size=3 maxlength=3></td></tr>
            ...
            <tr bgcolor=E7ECEB><td  bgcolor=E8EDEC colspan=2 align=center><a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=del&show=$show&id=$kv_talk_id><b>Удалить</b></a>&nbsp;<input type=submit value=Сохранить></td></tr>
            <tr bgcolor=E7ECEB><td  bgcolor=E7ECEB colspan=2 align=center><a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=addans&show=$show&id=$kv_talk_id#gotoadd><b>Добавить ответ</b></a></td></tr>
            </form>
            ";
            ...
            if (($action == "addans") && ($id == $kv_talk_id)) {
                ...
                <table>
                    ...
                    <tr><td width=150>Ежедневный:</td><td><input type=checkbox name=is_daily_ans /></td></tr>
                    ...
                    <tr><td width=100>Надо животное:</td><td><script>document.write(myreplacepet('need_pettype',/petse0/ig));</script> <input type=text name=need_petcount value=0 size=3 maxlength=3></td></tr>
        ...
        if ($kv_talk_ans_id <> "") {
            ...
            <table>
                ...
                <tr><td width=100>Ежедневный:</td><td><input type=checkbox name=is_daily_ans ".($is_daily_ans ? "checked" : "")."/></td></tr>
                ...
                <tr><td width=100>Надо животное:</td><td><script>document.write(myreplacepet('need_pettype',/petse$need_pettype/ig));</script>  <input type=text name=need_petcount value=$need_petcount size=3 maxlength=3></td></tr>
                ...
                <tr><td width=100>Открыть ID:</td><td><input type=text name=kv_talk_ans_goto value='$kv_talk_ans_goto' size=5 maxlength=5> <input type=submit value=Сохранить> <a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=delans&show=$show&id=$kv_talk_ans_id><b>Удалить</b></a></td></tr>
                </form>
            </table>
            </td></tr>";
        }
...
function npc()
{
    global $result,$npc_givemore,$npc_yell,$npc_pic,$n_resp_tim,$npc_sex,$def1,$def2,$action,$do,$npc_id,$load,$timeleft,$badis,$aggis,$npc_name,$n_id,$n_name,$n_room,$n_level,$n_aggresive,$n_resp_room,$n_bad,$n_live,$n_move,$n_on_location,$n_pwr,$n_typ,$n_typ_num,$n_typ2,$n_typ2_num,$n_typ3,$n_typ3_num,$n_heal,$cur_time,$online,$page,$givepercent,$give,$emune1,$emune2,$emune4,$emune8,$emune16,$emune32, $npc_display_in_library, $npc_inf_dev;
    ...
    if (isset($action)) {
        print "<div align=center><br>| <a href=bvgfvf7w83hr129jr1aw.php?load=$load&npc_name=$npc_name&action=add&badis=$bagis&timeleft=$timeleft&aggis=$aggis&page=$page>Добавить монстра</a> |<br><br></div>";
    }
    $sear = "";
    ...
    if ($action == 'save') {
        if ($npc_display_in_library != 1) {
            $npc_display_in_library = 0;
        }
    ...
    if ($action == 'new') {
        ...
        $SQL="insert into sw_users (npc,name,up_name,room,level,resp_room,bad,aggresive,live,move,on_location,pwr,typ,typ_num,typ2,typ2_num,typ3,typ3_num,heal,givepercent,give,def1,def2,sex,resp_time,pic,yell,emune,givemore,display_in_library,inf_dev) values (1,'$n_name',upper('$n_name'),$n_room,$n_level,$n_resp_room,$n_bad,$n_aggresive,$n_live,$n_move,$n_on_location,$n_pwr,$n_typ,$n_typ_num,$n_typ2,$n_typ2_num,$n_typ3,$n_typ3_num,$n_heal,$givepercent,$give,$def1,$def2,$npc_sex,$n_resp_tim,'$npc_pic','$npc_yell',$emune,$npc_givemore, $npc_display_in_library, '$npc_inf_dev')";
        SQL_do($SQL);
        //print "$SQL";
    }
    if ($action == 'online') {
    ...
    if (isset($action)) {
        ...
        for ($i=0;$i<$count;$i=$i+10) {
            ...
            if ($i == $page) {
                ...
                $p .= "|<a href=bvgfvf7w83hr129jr1aw.php?load=$load&page=$i&npc_name=$npc_name&action=show&badis=$badis&timeleft=$timeleft&aggis=$aggis class=menu>$i-$e</a>|";
            }
        }
        print "<div align=center>$p</div>";
        $SQL="select sex,id,name,room,level,resp_room,resp_time,bad,aggresive,live,move,on_location,pwr,typ,typ_num,typ2,typ2_num,typ3,typ3_num,heal,online,givepercent,give,givemore,def1,def2,pic,yell,emune, display_in_library, inf_dev from sw_users where npc=1 $sear order by level desc  limit $page,10";
        $row_num=SQL_query_num($SQL);
        while ($row_num) {
            $npc_sex = $row_num[0];
            $n_id = $row_num[1];
            ...
            $npc_display_in_library = $row_num[29];
            $npc_inf_dev = $row_num[30];
            ...
            if ($cur_time-60<$online) {
                $o = "<a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=online&online=$t&n_id=$n_id&page=$page>Живой</a>";
            } elseif ($online==0) {
                $o = "<a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=online&online=$t&n_id=$n_id&page=$page><font color=888800>Живой</font></a>";
            } else {
                $o = "<a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=online&online=0&n_id=$n_id&page=$page>Мёртвый</a>";
            }
            $top = "<table width=100%>
                        <tr><td  width=33%><b>Имя ($o):</b></td><td width=33%><input type=text name=n_name value='$n_name' size=15>&nbsp;$n_sex&nbsp;<input type=text name=npc_pic value='$npc_pic' size=10></td><td align=right><a href=bvgfvf7w83hr129jr1aw.php?load=$load&page=$page&action=del&n_id=$n_id&badis=$badis&timeleft=$timeleft&aggis=$aggis class=menu>Удалить</a></td><td align=right width=80><input type=submit value=Сохранить></td></tr>
                    </table>";
            $left = "<table width=100%>
            ...
            $right .= "</td></tr>
                        ...
                        <tr><td>Отображать в библиотеке:</td><td><input type='checkbox' name='npc_display_in_library' value='1'".($npc_display_in_library == 1 ? " checked" : "")."></td></tr>
                        <tr><td>Местоположение (библиотека):</td><td><input type='text' name='npc_inf_dev' value='$npc_inf_dev' size=25 maxlength=120></td></tr>
                    </table>";
...
function achievement()
{
    ...
    print "<div align=center><a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=add>Добавить достижение</a></div><br><br>";

    if ($action == "add") {
        print "<form action=bvgfvf7w83hr129jr1aw.php method=post><table width=90% align=center cellspacing=1 bgcolor=768E92>
        <input type=hidden name=load value=$load>
        <input type=hidden name=action value=new>
        <tr>
        <tr bgcolor=E7ECEB>
    ...
    while ($row_num) {
        ...
        <tr bgcolor=E7ECEB><td  bgcolor=E8EDEC colspan=4 align=center><input type=submit value=Изменить> <a href=bvgfvf7w83hr129jr1aw.php?load=$load&pacId=$acId&action=del>Удалить</a></td></tr>
        </table></form><br>";
...
function chat()
{
    ...
    print "<br><b>Выполнить магию:</b><br><a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=shake>» Тряска окна</a>";
    print "<br><a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=shake&c=2>» Тряска окна Академии</a>";
    print "<br><a href=bvgfvf7w83hr129jr1aw.php?load=$load&action=refresh>» Рефреш окна</a>";
...
function nickname()
{
    ...
    print "<form action=bvgfvf7w83hr129jr1aw.php name=t1 id=t1><input type=hidden name=load value=$load><input type=hidden name=action2 value=appr><table width=100% cellspacing=1 cellpadding=4 bgcolor=768E92 align=center>";
...
function unwer_object($id)
{
    $SQL="update sw_obj set active=0 where id=$id";
    SQL_do($SQL);
}

function news()
{
    global $action,$id,$post_sender,$post_date,$post_text,$post_is_important;

    if (!isset($post_is_important)) {
        $post_is_important = 0;
    }

    $news_page_size = 15;

    $com_text = "<br>| <a href=bvgfvf7w83hr129jr1aw.php?load=1&action=add1>Добавить новость</a> |  | <a href=bvgfvf7w83hr129jr1aw.php?load=1&action=gen>Сгенерировать HTML</a> |<br><br>";
    if ($action == "del") {
        $SQL="delete from sw_news where id=$id";
        SQL_do($SQL);
    }
    if ($action == "update") {
        $SQL="UPDATE sw_news SET date='$post_date',sender='$post_sender',text='$post_text', is_important=$post_is_important where id=$id";
        SQL_do_clean($SQL);
    }
    if ($action == "add2") {
        $SQL="INSERT INTO sw_news (date,sender,text,is_important) VALUES ('$post_date','$post_sender','$post_text', $post_is_important)";
        SQL_do_clean($SQL);
    }
    if ($action == "add1") {
        $com_text = "$com_text <form action=bvgfvf7w83hr129jr1aw.php method=get><input type=hidden name=action value=add2><input type=hidden name=load value=1>";
        ...
        $com_text = "$com_text <input type=\"checkbox\" name=\"post_is_important\" value=\"1\"> Важная | <input type=submit value=Создать class=but>";
    ...
    if ($action == "gen") {
        $news_current_page = 1;
        $file = fopen("news/news.htm", 'w');
    }

    $SQL="select id,date,sender,text,is_important from sw_news ORDER BY is_important DESC, id DESC";
    $i = 0;
    $row_num=SQL_query_num($SQL);
    $important_block_opened = false;
    while ($row_num) {
        $i++;
        $post_id = $row_num[0];
        $post_date = $row_num[1];
        ...
        $post_important_flag = '';
        if ($post_is_important) {
            $post_important_flag = ' checked';
        }

        $com_text = "$com_text <form action=bvgfvf7w83hr129jr1aw.php method=get><input type=hidden name=action value=update><input type=hidden name=id value=$post_id><input type=hidden name=load value=1>";
        $com_text = "$com_text<table width=450 align=center bgcolor=92A7AB>";
        $com_text = "$com_text<tr bgcolor=E3E9EA>";
        ...
        $com_text = "$com_text<tr>";
        $com_text = "$com_text<td colspan=2 align=right>";
        $com_text = "$com_text <input type=\"checkbox\" name=\"post_is_important\" value=\"1\"$post_important_flag> Важная | <a href=bvgfvf7w83hr129jr1aw.php?load=1&action=del&id=$post_id>Удалить</a>&nbsp;<input type=submit value=Сохранить class=but>";
        $com_text = "$com_text</td>";
        $com_text = "$com_text</tr>";
        $com_text = "$com_text</table></form><br>";
        if ($action == "gen") {
            if ($i > $news_page_size*$news_current_page) {
                fclose($file);

                $news_current_page++;
                $file = fopen("news/news$news_current_page.htm", 'w');
            }

            if (!$important_block_opened && $post_is_important) {
                $important_block_opened = true;
                fputs($file, "<table width=100% aling=center cellpadding=2 style=\"border: 1px solid grey; background-color: #E7EEE5;\"><tr><td style=\"color: red; text-align: center;\"><b>Важные новости:</b></td></tr><tr><td>");
            }
            if ($important_block_opened && (!$post_is_important || !$row_num)) {
                $important_block_opened = false;
...
<table width=780 align=center cellpadding=0 cellspacing=0>
    ...
    if ($admin_lvl == 3) {  // Модератор + Квестописец (пользователи только бан чата и бан)
        if (!isset($load)) {
            $load = 3;
        }
        $link[3] = "Пользователи";
    ...
    if ($admin_lvl == 5) {  // Главный модератор
        if (!isset($load)) {
            $load = 3;
        }
        $link[3] = "Пользователи";
    ...
    if ($admin_lvl == 6) {  // Модератор (пользователи только бан чата и бан)
        if (!isset($load)) {
            $load = 3;
        }
        $link[3] = "Пользователи";
    ...
    if ($admin_lvl == 7) {    // организатор турниров
        if (!isset($load)) {
            $load = 3;
        }
        $link[3] = "Пользователи";
    ...
    for ($i=0;$i<=24;$i++) {
        if ($link[$i] <> "") {
            if ($i <> $load) {
                print "<tr><td bgcolor=EDF1F1 valign=top height=15 onmouseover='this.bgColor=\"#FFFFCC\"' onmouseout='this.bgColor=\"#EDF1F1\"' style='cursor:hand'>&nbsp;<a href=bvgfvf7w83hr129jr1aw.php?load=$i class=menu>» $link[$i]</a></td></tr>";
            } else {
                print "<tr><td bgcolor=DDE0E0 valign=top height=15 onmouseover='this.bgColor=\"#FFFFCC\"' onmouseout='this.bgColor=\"#DDE0E0\"' style='cursor:hand'>&nbsp;<a href=bvgfvf7w83hr129jr1aw.php?load=$i class=menu>» $link[$i]</a></td></tr>";
            }
        }
    } ?>
    ...
    if (($load == 10) && $link[$load] <> "") {
        stuff();
    }

    if (($load == 11) && $link[$load] <> "") {
        arena();
    }

    if (($load == 12) && $link[$load] <> "") {
        npc();
    }

    if (($load == 13) && $link[$load] <> "") {
        makeobj();
    }

    if (($load == 14) && $link[$load] <> "") {
        clan();
    }

    if (($load == 15) && $link[$load] <> "") {
        kvest();
    }

    if (($load == 16) && $link[$load] <> "") {
        obraz();
    }

    if (($load == 17) && $link[$load] <> "") {
        ipsearch();
    }

    if (($load == 18) && $link[$load] <> "") {
        weather();
    }

    if (($load == 19) && $link[$load] <> "") {
        nickname();
    }

    if (($load == 20) && $link[$load] <> "") {
        clanlog();
    }

    if (($load == 21) && $link[$load] <> "") {
        uploadpic();
    }

    if (($load == 22) && $link[$load] <> "") {
        antiteleport();
    }

    if (($load == 23) && $link[$load] <> "") {
        sw_log();
    }

    if (($load == 24) && $link[$load] <> "") {
        achievement();
    } ?>
                                </td>
                            </tr>
