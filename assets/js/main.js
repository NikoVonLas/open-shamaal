...
function close_window_func() {
    close();
}
function startExTimer(secsss){
timeInSecsEX = parseInt(secsss)-1;
tickerEX = setInterval("tickEX()",1000);
}


function showNotification(ntitle, nbody, nicon) {
...
function notifyUser(img,title,texto){
talk.noty({
		text     : '<div ><img src="/assets/img/'+img+'" alt="'+title+'" title="'+title+'" style="float: left;padding-bottom:10px;"/> <strong>'+title+'</strong> <br />'+texto+'</div>',
		layout   : 'bottomRight',
		timeout: 15000,
		maxVisible: 2,
		closeWith: ['click']
...
if (window.top.frames['mtop'].document.getElementById('toptext'))
{
	...
	window.top.frames['mtop'].document.getElementById('toptext').innerHTML = '<div><img width=0 height=5></div><table class=blue cellpadding=0 cellspacing=1 width=90% align=center><tr><td class=bluetop><table cellpadding=0 cellspacing=0><tr><td class=gal><table cellspacing=0 cellpadding=0 width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td><b>Поиграй в одну интересную игру</b></td></tr></table></td></tr><tr><td class=mainb height=265 bgcolor=FFFFFF valign=top><table width=100% align=center cellpadding=0 cellspacing=0><tr><td>'+barabash+'</td></tr></table></td></tr></table>';
...
if (window.top.frames['mtop'].document.getElementById('toptext'))
{
	...
	window.top.frames['mtop'].document.getElementById('toptext').innerHTML = '<div><img width=0 height=5></div><table class=blue cellpadding=0 cellspacing=1 width=90% align=center><tr><td class=bluetop><table cellpadding=0 cellspacing=0><tr><td class=gal><table cellspacing=0 cellpadding=0 width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td><b>Возврат Образов</b></td></tr></table></td></tr><tr><td class=mainb height=265 bgcolor=FFFFFF valign=top><table width=100% align=center cellpadding=0 cellspacing=0><tr><td>'+barabash+'</td></tr></table></td></tr></table>';
...
if (window.top.frames['mtop'].document.getElementById('toptext'))
{
	...
	if ((rmax >= rnum) && (rnum > 0))
	{
		if (window.top.frames['mtop'].document.getElementById('rudnum'))
		{
			...
			window.top.frames['mtop'].document.getElementById('rimg').src = '/assets/img/stuff/else/'+rudaimg[r1];
			window.top.frames['mtop'].document.getElementById('iimg').src = '/assets/img/stuff/else/ingot'+rudaimg[r1];
		}
	}
	else
	{
...
if (window.top.frames['mtop'].document.getElementById('toptext'))
{
	if (col < 0)
		...
		c = '<b>'+col+'</b>';
	main = "<table height=100% width=100%><tr><td><table width=95%><tr valign=top><td align=center width=33%><b>Руда</b><br><div id=leftruda><img src=/assets/img/stuff/else/ruda.gif id=rimg></div></td><td width=33% align=center><b>Переплавка</b><br><table><tr><td>Количество:</td><td id=rudnum>?</td></tr><tr><td>Результат:</td><td id=rudon>"+c+"</td></tr></table><font id=rudabutton><input type=button value=Переплавить disabled></font></td><td align=center><b>Слиток</b><br><div id=rightruda><img src=/assets/img/stuff/else/slitok.gif id=iimg></div></td></tr><tr><td colspan=3 height=20><table width=85% cellspacing=1 bgcolor=8C9AAD align=center height=15><tr><td bgcolor=BDC7DE align=center width="+per+"%>"+per+"%</td><td bgcolor=E6EAEF></td></tr></table></td></tr></table> </td></tr></table>";
	left = '<tr><td align=center width=60><img src=/assets/img/stuff/else/'+rudaimg[1]+' width=35 height=35></td><td align=center><b>Бронза</b><br><table cellspacing=0><tr><td><input type=text value='+ruda1+' size=3 id=r1></td><td>/ '+ruda1+'</td><td><input type=button value=» onclick="window.top.addforge(1,'+ruda1+');"></td></tr></table></td></tr>';
	left += '<tr><td align=center width=60><img src=/assets/img/stuff/else/'+rudaimg[2]+' width=35 height=35></td><td align=center><b>Железо</b><br><table cellspacing=0><tr><td><input type=text value='+ruda2+' size=3 id=r2></td><td>/ '+ruda2+'</td><td><input type=button value=» onclick="window.top.addforge(2,'+ruda2+');"></td></tr></table></td></tr>';
	left += '<tr><td align=center width=60><img src=/assets/img/stuff/else/'+rudaimg[3]+' width=35 height=35></td><td align=center><b>Роза</b><br><table cellspacing=0><tr><td><input type=text value='+ruda3+' size=3 id=r3></td><td>/ '+ruda3+'</td><td><input type=button value=» onclick="window.top.addforge(3,'+ruda3+');"></td></tr></table></td></tr>';
	left += '<tr><td align=center width=60><img src=/assets/img/stuff/else/'+rudaimg[4]+' width=35 height=35></td><td align=center><b>Серебро</b><br><table cellspacing=0><tr><td><input type=text value='+ruda4+' size=3 id=r4></td><td>/ '+ruda4+'</td><td><input type=button value=» onclick="window.top.addforge(4,'+ruda4+');"></td></tr></table></td></tr>';
	left += '<tr><td align=center width=60><img src=/assets/img/stuff/else/'+rudaimg[5]+' width=35 height=35></td><td align=center><b>Золото</b><br><table cellspacing=0><tr><td><input type=text value='+ruda5+' size=3 id=r5></td><td>/ '+ruda5+'</td><td><input type=button value=» onclick="window.top.addforge(5,'+ruda5+');"></td></tr></table></td></tr>';
	left += '<tr><td align=center width=60><img src=/assets/img/stuff/else/'+rudaimg[6]+' width=35 height=35></td><td align=center><b>Ветрий</b><br><table cellspacing=0><tr><td><input type=text value='+ruda6+' size=3 id=r6></td><td>/ '+ruda6+'</td><td><input type=button value=» onclick="window.top.addforge(6,'+ruda6+');"></td></tr></table></td></tr>';
	left += '<tr><td align=center width=60><img src=/assets/img/stuff/else/'+rudaimg[7]+' width=35 height=35></td><td align=center><b>Крентаврий</b><br><table cellspacing=0><tr><td><input type=text value='+ruda7+' size=3 id=r7></td><td>/ '+ruda7+'</td><td><input type=button value=» onclick="window.top.addforge(7,'+ruda7+');"></td></tr></table></td></tr>';
	window.top.frames['mtop'].document.getElementById('toptext').innerHTML = '<div><img width=0 height=5></div><table class=blue cellpadding=0 cellspacing=1 width=90% align=center><tr><td class=bluetop width=34%><table cellpadding=0 cellspacing=0><tr><td class=gal><table cellspacing=0 cellpadding=0 width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td><b>Руда в рюкзаке</b></td></tr></table></td><td class=bluetop><table cellpadding=0 cellspacing=0><tr><td class=gal><table cellspacing=0 cellpadding=0 width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td><b>Результат работы</b></td></tr></table></td></tr><tr><td class=mainb height=265 bgcolor=FFFFFF valign=top><table width=85% align=center cellpadding=0 cellspacing=0>'+left+'</table></td><td class=mainb height=265 bgcolor=FFFFFF valign=top>'+main+'</td></tr></table>';
}
}
...
if (window.top.frames['mtop'].document.getElementById('toptext'))
{
	...
	if (g == 0)
		window.top.frames['mtop'].document.getElementById('toptext').innerHTML = '<div><img width=0 height=5></div><table class=blue cellpadding=0 cellspacing=1 width=500 align=center><td class=bluetop><table cellpadding=0 cellspacing=0><tr><td class=gal><table cellspacing=0 cellpadding=0 width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td><b>'+sk+'</b></td></tr></table></td></tr><tr><td class=mainb height=265 bgcolor=FFFFFF valign=top>'+main+'</td></tr></table>';
}
}
...
{
	window.top.frames['mbar'].document.getElementById('sleep').src= "/assets/img/"+img;
	if (img == 'sleep.gif')
...
if (window.top.frames['talk'].document.getElementById('tbox'))
{
	...
	theResult2 = t.indexOf('[<b>'+player_name+'</b>]');
	if (theResult2 != -1)
		style = 'red2';
	else if (theResult != -1)
		style = 'red';
...
function doreguest(r)
{
	...
	if (iframe)
	{
		...
		iframe.document.getElementById('regall').innerHTML = reg_text;
	}
...
function tatol(sid,id,id1,name1,id2,name2,sum,p,num,hp1,hp2)
{
	...
	else
	{
		...
		reg_text += '<tr bgcolor=D7DBDF><TD><form action=/menu.php target=menu><table cellpadding=0 cellspacing=0 width=100%><input type=hidden name=load value=arena><input type=hidden name=action value=3><input type=hidden name=sidd value='+id+'><input type=hidden name=id value='+sid+'><input type=hidden name=reg value='+id1+'><input type=hidden name=do value=total><Tr><td width=15><a href=./fullinfo.php?name='+name1+' target=_blank><img src=/assets/img/game/info.gif width=13 height=13></td><td width=100%>&nbsp;'+name1+'</td></tr><tr><td colspan=2>'+ent+hpone+'</td></tr></table></form></td><TD><form action=/menu.php target=menu><table cellpadding=0 cellspacing=0 width=100%><input type=hidden name=sidd value='+id+'><input type=hidden name=load value=arena><input type=hidden name=action value=3><input type=hidden name=id value='+sid+'><input type=hidden name=reg value='+id2+'><input type=hidden name=do value=total><Tr><td width=15><a href=./fullinfo.php?name='+name2+' target=_blank><img src=/assets/img/game/info.gif width=13 height=13></td><td width=100%>&nbsp;'+name2+'</td></tr><tr><td colspan=2>'+ent+hptwo+'</td></tr></table></form></td><TD align=center>'+sum+'</td></tr>';
...
function regdo(sid,id,name,level,tim,allowbet,p)
{
	...
	else
	{
		...
		reg_text += '<tr bgcolor=D7DBDF><TD  align=center width=40>'+tim+'</td><TD><table cellpadding=0 cellspacing=0><Tr><td><a href=./fullinfo.php?name='+name+' target=_blank><img src=/assets/img/game/info.gif></td><td>&nbsp;'+name+'</td></tr></table></td><TD width=60 align=center>'+level+'</td><TD align=center width=100>'+ent+'</td></tr></form>';
	}
}
...
if (window.top.frames['mtop'].document.getElementById('toptext'))
{
	...
	invrnd = ran;
	inform = '<table width=230 height=290 bgcolor=8C9AAD cellpadding=1 cellspacing=1><tr><td class=bluetop><table cellpadding=0 cellspacing=0><tr><td class=gal><table cellspacing="0" cellpadding="0" width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td id=topname>Вместимость <font id=cweig></font>&nbsp;(<font id=mweig>'+maxwg+'</font>)</td></tr></table></td></tr><tr><td bgcolor=F7FBFF><iframe src="/frames/iframe.php?ran='+ran+'" id=iframe'+ran+' width="235" height="100%" marginwidth="0" marginheight="0" frameborder="0" style="background-color: #AAAAAA;"></iframe></td></tr></table>';
	mtxt = '<table width=100% height=290 bgcolor=8C9AAD cellpadding=1 cellspacing=1><tr><td class=bluetop><table cellpadding=0 cellspacing=0 width=100%><tr><td class=gal><table cellspacing="0" cellpadding="0" width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td id=topname><table width=100% cellpadding=0 cellspacing=0><tr><TD>'+myname+'</td><td id=mybut align=right></td></tr></table></td></tr></table></td></tr><tr><td bgcolor=F7FBFF height=50% valign=top><table cellpadding=4 width=100%><tr><tD id=mytr ></td></tr></table></td></tr><tr><td class=bluetop><table cellpadding=0 cellspacing=0 width=100%><tr><td class=gal><table cellspacing="0" cellpadding="0" width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td id=topname><table width=100% cellpadding=0 cellspacing=0><tr><TD>'+hisname+'</td><td id=hisbut align=right></td></tr></table></td></tr></table></td></tr><tr><td bgcolor=F7FBFF height=50% valign=top><table cellpadding=4 width=100%><tr><td id=hetr></td></tr></table></td></tr></table>';
...
if (window.top.frames['mtop'].document.getElementById('toptext'))
{
	...
	if (x == 1)
	{
		...
		main = '<table width=90% cellpadding=5 align=center><tr><td><table class=blue cellpadding=0 cellspacing=1 width=100% align=center><tr><td class=bluetop><table cellpadding=0 cellspacing=0><tr><td class=gal><table cellspacing=0 cellpadding=0 width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td>'+title+'</td></tr></table></td></tr><tr><td class=mainb height=265 bgcolor=FFFFFF valign=top>'+text+'</td></tr></table></td></tr></table>';
...
if (window.top.frames['mtop'].document.getElementById('toptext'))
{
	...
	main = '<table class=blue cellpadding=0 cellspacing=1 width=100%><tr><td class=bluetop><table cellpadding=0 cellspacing=0 width=100%><tr><td class=gal><table cellspacing=0 cellpadding=0 width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td>'+text+'</td></tr></table></td></tr><tr><td class=mainb height=265 bgcolor=FFFFFF valign=top>'+info+'</td></tr></table>';
	window.top.frames['mtop'].document.getElementById('toptext').innerHTML = '<table width=95% align=center cellspacing=0 cellpadding=3 height=300 ><tr><td width=140 valign=top height=120><img src=/assets/img/'+pic+' alt='+mt+'></td><td rowspan=2>'+main+'</td></tr><tr><td valign=top '+p+' width=140>'+menu+'&nbsp;</td></tr></table>';
}
}
...
if (window.top.frames['mtop'].document.getElementById('toptext'))
{
	...
	main = '<table class=blue cellpadding=0 cellspacing=1 width=100%><tr><td class=bluetop><table cellpadding=0 cellspacing=0 width=100%><tr><td class=gal><table cellspacing=0 cellpadding=0 width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td>'+text+'</td></tr></table></td></tr><tr><td class=mainb height=265 bgcolor=FFFFFF valign=top>'+info+'</td></tr></table>';
	window.top.frames['mtop'].document.getElementById('toptext').innerHTML = '<table width=95% align=center cellspacing=0 cellpadding=3 height=300 ><tr><td width=140 valign=middle height=100%><img src=/assets/img/'+pic+' alt='+mt+'></td><td rowspan=2>'+main+'</td></tr><tr><td valign=top '+p+' width=140>'+menu+'&nbsp;</td></tr></table>';
}
}
...
function addMute(time)
{
	...
	{
		window.top.frames['users'].document.getElementById('mute').innerHTML = '<img src=/assets/img/mute.gif onmouseout="hide_info(this);" onmouseover="tooltip(this,\'Бан чата, осталось : '+time+'\');">';
	}
...
if (party == 0)
	par = '<a href=/menu.php?load=addparty&id='+id+' target=menu><img src="/assets/img/game/noparty.gif" width="13" height="13" border="0" alt=""></a>';
else if (party == 1)
	par = '<img src="/assets/img/game/party.gif" width="13" height="13" border="0" alt="">';
else
	par = '';
if (per != -1)
{
	if (per == 10)
		hp = '<table cellpadding=0 cellspacing=1 bgcolor=333333 width=10 height=10><tr><td bgcolor=CC0000 height='+per+' width=10></td></tr></table>';
	else
		hp = '<table cellpadding=0 cellspacing=1 bgcolor=333333 width=10 height=10><tr><td bgcolor=F6FAFF height='+(10-per)+' width=10></td></tr><tr><td bgcolor=CC0000 height='+per+'></td></tr></table>';
}
else
	hp = '';
...
if(m == 1)
{
	mute = "<img src=/assets/img/mute.gif>"
}
else
{
	mute = "";
...
user_text += '<div id=text'+id+'><table cellpadding=2 cellspacing=0 width=100% id=text'+id+'><tr><td width=12>'+hp+'</td><td width=40>'+mute+'<a href="./fullinfo.php?name='+name+'" target="_blank"><img src=/assets/img/game/info.gif width=13 height=13></a></td> <td width=18>'+par+'</td> <td width=18><a href=\"/menu.php?load=settarget&t_name='+name+'&t_id='+id+'\" target=menu><img src=/assets/img/game/attack.gif width=15 height=15></a></td><td width=20>[<a onclick="window.top.textenter(\'/приват '+name+'\');" style=cursor:hand><font color=00237B><b>П</b></font></a>]</td> <td><a onclick=\'window.top.entertext("'+name+'");\' style=cursor:hand class='+colors[color]+'>'+name+'</a>&nbsp;'+clan+'</td></tr></table></div>'
}
function fu(num,cit)
{
if (window.top.frames['users'])
...
if (window.top.frames['mtop'].document.getElementById('toptext'))
{
    ...
    if (h_up > 0)
		up = '<img src=/assets/img/game/up.gif border=0 width=8 height=8>';
	else
		up = '';
    if (h_down > 0)
    	down = '<img src=/assets/img/game/down.gif border=0 width=8 height=8>';
    else
    	down = '';
	if (city_rank != "")
	...
	samulet = '<a href=/menu.php?load=useobj&obj_id='+amuletid+' target=menu><img src=/assets/img/stuff/'+amulet+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+amulettext+'");></a>';
	sring1 = '<a href=/menu.php?load=useobj&obj_id='+ring1id+' target=menu><img src=/assets/img/stuff/'+ring1+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+ring1text+'");></a>';
	sring2 = '<a href=/menu.php?load=useobj&obj_id='+ring2id+' target=menu><img src=/assets/img/stuff/'+ring2+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+ring2text+'");></a>';
	sbody = '<a href=/menu.php?load=useobj&obj_id='+bodyid+' target=menu><img src=/assets/img/stuff/'+body+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+bodytext+'");></a>';
	ssword = '<a href=/menu.php?load=useobj&obj_id='+swordid+' target=menu><img src=/assets/img/stuff/'+sword+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+swordtext+'");></a>';
	sglove = '<a href=/menu.php?load=useobj&obj_id='+gloveid+' target=menu><img src=/assets/img/stuff/'+glove+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+glovetext+'");></a>';
	shelmet = '<a href=/menu.php?load=useobj&obj_id='+helmetid+' target=menu><img src=/assets/img/stuff/'+helmet+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+helmettext+'");></a>';
	scloak = '<a href=/menu.php?load=useobj&obj_id='+cloakid+' target=menu><img src=/assets/img/stuff/'+cloak+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+cloaktext+'");></a>';
	sshield = '<a href=/menu.php?load=useobj&obj_id='+shieldid+' target=menu><img src=/assets/img/stuff/'+shield+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+shieldtext+'");></a>';
	slegs = '<a href=/menu.php?load=useobj&obj_id='+legsid+' target=menu><img src=/assets/img/stuff/'+legs+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+legstext+'");></a>';

	img = '<table cellpadding=0 cellspacing=0 width=280><tr><td background=/assets/img/game/b2slot.gif width=64 height=32 align=center>'+samulet+'</td><td rowspan=5 width=150 align=center><img src=/assets/img/obraz/'+pic+'></td><td rowspan=2 background=/assets/img/game/bslot.gif  width=64  height=64 align=center>'+shelmet+'</td></tr><tr><td  height=32><table width=100% height=100% cellpadding=0 cellspacing=0><tr><td background=/assets/img/game/b3slot.gif align=center width=32>'+sring1+'</td><td  background=/assets/img/game/b3slot.gif align=center>'+sring2+'</td></tr></table></td></tr><tr><td background=/assets/img/game/b4slot.gif height=70 align=center>'+sbody+'</td><td background=/assets/img/game/b4slot.gif  height=70 align=center>'+scloak+'</td></tr><tr><td background=/assets/img/game/b4slot.gif  height=70 align=center>'+ssword+'</td><td background=/assets/img/game/b4slot.gif  height=70 align=center>'+sshield+'</td></tr><tr><td background=/assets/img/game/bslot.gif  height=64 align=center>'+sglove+'</td><td background=/assets/img/game/bslot.gif  height=64 align=center>'+slegs+'</td></tr></table>';
	inform = `
    <table width=240 cellpadding=1 cellspacing=1>
        <tr>
            <td class=info1>Имя:</td>
            <td class=info2 colspan=3>${name}</td>
        </tr>
        <tr>
            <td class=info1>Уровень:</td>
            <td class=info2 colspan=3>${level}</td>
        </tr>
        <tr>
            <td class=info1>Опыт:</td>
            <td class=info2 colspan=3>${expp}</td>
        </tr>
        <tr>
            <td class=info1>Раса:</td>
            <td class=info2 colspan=3>${race}</td>
        </tr>
        <tr>
            <td class=info1>Пол:</td>
            <td class=info2 colspan=3>${sex}</td>
        </tr>
        <tr>
            <td colspan=4 height=0 bgcolor=888888></td>
        </tr>
        <tr>
            <td class=info1>Увеличений:</td>
            <td class=info2 id=h_p colspan=3>${h_up}</td>
        </tr>`;
        if (h_down > 0) {
            inform += `
            <tr>
                <td class=info1>Сбросов:</td>
                <td class=info2 id=h_p colspan=3>${h_down}</td>
            </tr>`;
        }
        inform += `
        <tr>
        ...
        <tr>
            <td class=info1>Уроков:</td>
            <td class=info2 colspan=3>${s_up}</td>
        </tr>
        <tr>
            <td class=info1>Золото:</td>
            <td class=info2 colspan=3>${gold}</td>
        </tr>
        <tr>
            <td class=info1>Рейтинг:</td>
            <td class=info2 colspan=3>${rating} <a href=# onclick="javascript:NewWnd=window.open('fight.php?id=${id}', 'fight', 'width=550,height=500,toolbar=0,location=no,status=0,scrollbars=1,resizable=0,left=20,top=20');" class=menu2>[Список]</a></td>
        </tr>
        <tr>
            <td class=info1>Город:</td>
            <td class=info2 colspan=3>${cname}</td>
        </tr>
        ${city_rank}
        ${nick}
    </table>`;
...
//	affl[12] = 'Скорость';
	...
	if (what != 0)
		if (!(window.top.frames['info'].document.getElementById('afl'+what)))
			window.top.frames['info'].document.getElementById('effect').innerHTML += '<font id=afl'+what+'><img src=/assets/img/stuff/aff/'+what+'.gif alt='+affl[what]+' onmouseout="hide_info(this);" onmouseover="tooltip(this,\''+affl[what]+'\');"></font>';
}
...
function readSkillsSettings() {
    var settings = new Object();
    var settingsString = $.cookie("skillSet-"+ player_id);
...
if (window.top.frames['mtop'].document.getElementById('toptext'))
{
	...
	window.top.frames['mtop'].document.getElementById('toptext').innerHTML = '<div><img height=10 width=0></div><table width=95% height=290 align=center cellspacing=1 cellpadding=0 class=blue><tr><td width=150 class=bluetop><table cellpadding=0 cellspacing=0><tr><td class=gal><table cellspacing=0 cellpadding=0 width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td>Эликсиры</td></tr></table></td><td class=bluetop><table cellpadding=0 cellspacing=0 width=100%><tr><td class=gal><table cellspacing=0 cellpadding=0 width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td style="width: 140px;">Атакующие действия</td><td style="font-size: 9px; font-weight: bold; color: #464F5A; cursor: hand;"><span id="skills-edit-button">Редактировать</span><span id="skills-edit-save-button" style="display: none; color: #1F5C1F;">Сохранить</span>&nbsp;<span id="skills-edit-cancel-button" style="display: none; color: #800000;">Отменить</span></td></tr></table></td></tr><tr><td class=mainb valign=top height=\"100%\"><table cellpadding=0 cellspacing=0 width=100% height=100%><tr><td valign=top height=120>'+links+'</td></tr><tr><td valign=top height=80><table style=\"border-spacing: 0 1px;\" bgcolor=\"#8C9AAD\" width=100% cellpadding=3><tr bgcolor=\"#BDCBDE\"><td style=cursor:hand onmouseover=this.bgColor=\"#DAE8FB\" onmouseout=this.bgColor=\"#BDCBDE\" onclick=window.top.block(1); id=blk1>» '+blok[1]+'</td></tr><tr bgcolor=\"#BDCBDE\"><td style=cursor:hand onmouseover=this.bgColor=\"#DAE8FB\" onmouseout=this.bgColor=\"#BDCBDE\"  onclick=window.top.block(2);  id=blk2>» '+blok[2]+'</td></tr>'+
	'<tr bgcolor=\"#BDCBDE\"><td style=cursor:hand onmouseover=this.bgColor=\"#DAE8FB\" onmouseout=this.bgColor=\"#BDCBDE\"  onclick=window.top.block(3);  id=blk3>» '+blok[3]+'</td></tr><tr bgcolor=\"#BDCBDE\"><td style=cursor:hand onmouseover=this.bgColor=\"#DAE8FB\" onmouseout=this.bgColor=\"#BDCBDE\"  onclick=window.top.block(4);  id=blk4>» '+blok[4]+'</td></tr></table></td></tr><tr><td class=bluetop><table cellpadding=0 cellspacing=0><tr><td class=gal><table cellspacing=0 cellpadding=0 width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td>Запоминание</td></tr></table></td></tr><tr><td height=1 bgcolor=\"#8898AF\"></td></tr><tr><td id=remember align=center></td></tr></table></td><td class=mainb valign=top rowspan=2><table cellpadding=0 cellspacing=0 height=100% width=100%><tr><td><iframe src=/frames/sframe.php?ran='+ran+' name=sframe'+ran+' width=100% height=100% marginwidth=2 marginheight=2 frameborder=0></iframe></td></tr></table></td></tr></table>';
}
}
function remreset()
{
...
{
    if (skillsSettings === undefined) {
        skillsSettings = readSkillsSettings();
    }

    var displayNone = "";
    if (skillsSettings[n] !== undefined) {
        if (skillsSettings[n] == "0") {
    ...
    toptext = '<div id=delall'+n+' style="'+displayNone+'"><table cellpadding=0 cellspacing=0 class=blue width=99% align=center style="margin-top: 1px;"><tr><td bgcolor=BDCBDE class="ability-name" style="border: 1px solid #8898AF; padding: 2px; border-bottom: 0;"><b> <font id=del'+n+'><font onclick=setattr('+n+',1); style="cursor:hand">»</font></font> '+text+'</b><span class="abilities-disable-button" data-ability-id="'+n+'" style="font-size: 9px; font-weight: bold; cursor: hand; color: #800000; display: none;">&nbsp;Скрыть</span><span class="abilities-enable-button" data-ability-id="'+n+'" style="font-size: 9px; font-weight: bold; cursor: hand; color: #1F5C1F; display: none;">&nbsp;Показать</span></td></tr><tr><td colspan="4"><table class=blue cellpadding=2 cellspacing=1 width=100%><tbody class=\"skillsSortable\">';
    SkillText += toptext;
    toppertext[n] = toptext;
    topper[n] = '<div id=delall'+n+' style="'+displayNone+'"><table class=blue cellpadding=2 cellspacing=1 width=99% align=center style="margin-top: 1px;"><tr><td bgcolor=BDCBDE><b> <font id=del'+n+'><font onclick=setattr('+n+',2); style="cursor:hand">+</font></font> '+text+'</b></td></tr></table></div>';
...
function mains(type,name,sk,num)
{
    ...
    if (skillsSettings[sk] !== undefined && skillsSettings[sk][num] !== undefined) {
        if (skillsSettings[sk][num] == "0") {
            displayNone = "display: none";
        }
    }

    editorButtons = "<tr class=\"skills-buttons\"><td><span class=\"skills-disable-button\" data-skill-id=\""+num+"\" data-ability-id=\""+sk+"\" style=\"font-size: 9px; font-weight: bold; cursor: hand; color: #800000; display: none;\">&nbsp;Скрыть</span><span class=\"skills-enable-button\" data-skill-id=\""+num+"\" data-ability-id=\""+sk+"\" style=\"font-size: 9px; font-weight: bold; cursor: hand; color: #1F5C1F; display: none;\">&nbsp;Показать</span></td></tr>";
    tx = "<input type=hidden name=load value=attack><input type=hidden name=num value="+num+"><input type=hidden name=skill_id value="+sk+"><tr class=mainb style=\""+displayNone+"\"><td><table width=99% cellspacing=0 cellpadding=1 align=center>"+editorButtons+"<tr><td width=35% class=skillname><b>"+name+"</b></td>";
...
{
    if (!topOpened) return;
SkillText += '</tbody></table></td></tr></table></div>';
}
...
if (window.top.frames['mtop'].document.getElementById('toptext'))
{
	...
	window.top.frames['mtop'].document.getElementById('toptext').innerHTML = '<div><img height=8 width=0></div><table width=500 height=280 background=/assets/img/game/viewbook.jpg align=center><tr><td>'+text+'</td></tr></table>';
}
}
...
if (window.top.frames['mtop'].document.getElementById('toptext'))
{
	...
	if (typ == 2)
		window.top.frames['mtop'].document.getElementById('toptext').innerHTML = '<div><img height=8 width=0></div><table align=center cellpadding=0 cellspacing=0><tr><td width=339 height=50 background="/assets/img/stuff/else/scrollwindow.top.gif"></td></tr><tr><td height=190 background="/assets/img/stuff/else/scrollcenter.gif" valign=top align=center>'+page1+'</td></tr><tr><td height=39 background="/assets/img/stuff/else/scrollbottom.gif"></td></tr></table>';
}
}
...
if (window.top.frames['mtop'].document.getElementById('toptext'))
{
	...
	samulet = start+amuletid+' target=menu><img src=/assets/img/stuff/'+amulet+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+amulettext+'");></a>';
	sring1 = start+ring1id+' target=menu><img src=/assets/img/stuff/'+ring1+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+ring1text+'");></a>';
	sring2 = start+ring2id+' target=menu><img src=/assets/img/stuff/'+ring2+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+ring2text+'");></a>';
	sbody = start+bodyid+' target=menu><img src=/assets/img/stuff/'+body+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+bodytext+'");></a>';
	ssword = start+swordid+' target=menu><img src=/assets/img/stuff/'+sword+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+swordtext+'");></a>';
	sglove = start+gloveid+' target=menu><img src=/assets/img/stuff/'+glove+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+glovetext+'");></a>';
	shelmet = start+helmetid+' target=menu><img src=/assets/img/stuff/'+helmet+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+helmettext+'");></a>';
	scloak = start+cloakid+' target=menu><img src=/assets/img/stuff/'+cloak+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+cloaktext+'");></a>';
	sshield = start+shieldid+' target=menu><img src=/assets/img/stuff/'+shield+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+shieldtext+'");></a>';
	slegs = start+legsid+' target=menu><img src=/assets/img/stuff/'+legs+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+legstext+'");></a>';
	img = '<table cellpadding=0 cellspacing=0 width=280><tr><td background=/assets/img/game/b2slot.gif width=64 height=32 align=center>'+samulet+'</td><td rowspan=5 width=150 align=center><img src=/assets/img/obraz/'+pic+'></td><td rowspan=2 background=/assets/img/game/bslot.gif  width=64  height=64 align=center>'+shelmet+'</td></tr><tr><td  height=32><table width=100% height=100% cellpadding=0 cellspacing=0><tr><td background=/assets/img/game/b3slot.gif align=center width=32>'+sring1+'</td><td  background=/assets/img/game/b3slot.gif align=center>'+sring2+'</td></tr></table></td></tr><tr><td background=/assets/img/game/b4slot.gif height=70 align=center>'+sbody+'</td><td background=/assets/img/game/b4slot.gif  height=70 align=center>'+scloak+'</td></tr><tr><td background=/assets/img/game/b4slot.gif  height=70 align=center>'+ssword+'</td><td background=/assets/img/game/b4slot.gif  height=70 align=center>'+sshield+'</td></tr><tr><td background=/assets/img/game/bslot.gif  height=64 align=center>'+sglove+'</td><td background=/assets/img/game/bslot.gif  height=64 align=center>'+slegs+'</td></tr></table>';
	inform = '<table width=100% height=263 bgcolor=8C9AAD cellpadding=1 cellspacing=1><tr bgcolor=BDCBDE><td valign=top height=32><table width=100% height=32><tr><td background=/assets/img/stuff/else/bag'+quality+'.gif height=30 width=28></td><td align=center>Качество рюкзака:<br><b>'+bquality[quality]+'</b></td></tr></table></td></tr>'+
	'<tr><td class=bluetop><table cellpadding=0 cellspacing=0><tr><td class=gal><table cellspacing="0" cellpadding="0" width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td id=topname>Вместимость '+cw+' ('+w+')</td></tr></table></td></tr>'+

	'<tr><td bgcolor=F7FBFF><iframe src="/frames/iframe.php?ran='+ran+'" id="iframe'+ran+'" width="100%" height="200" marginwidth="0" marginheight="0" frameborder="0" style="background-color: #AAAAAA;"></iframe></td></tr></table>';
	window.top.frames['mtop'].document.getElementById('toptext').innerHTML = '<table cellpadding=5 align=center width=80%><tr><td width=290>'+img+'</td><td align=right valign=top>'+inform+'</td></tr></table>';
}
}
...
if (fr.document.getElementById('toptext'))
{
	...
	if (per != 0)
		...
		cit = '';
	fr.document.getElementById('toptext').innerHTML = '<div><img width=0 height=5></div><table class=blue cellpadding=0 cellspacing=1 width=95% align=center><tr><td class=bluetop width=34%><table cellpadding=0 cellspacing=0><tr><td class=gal><table cellspacing=0 cellpadding=0 width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td><b>Имеющийся товар</b></td></tr></table></td><td class=bluetop><table cellpadding=0 cellspacing=0><tr><td class=gal><table cellspacing=0 cellpadding=0 width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td><b>'+text+'</b></td></tr></table></td></tr><tr><td class=mainb height=265 bgcolor=FFFFFF valign=top><table width=80% align=center height=80%><tr><td valign=top>'+menu+'</td></tr></table><table width=90% align=center><tr><td align=center>'+cit+'</td></tr></table></td><td class=mainb height=265 bgcolor=FFFFFF valign=top><iframe src=/iframe.php?ran='+ran+' name=iframe'+sho+'  id=iframe'+sho+'  width=100% height=100% marginwidth=2 marginheight=2 frameborder=0></iframe></td></tr></table>';
...
if (fr.document.getElementById('toptext'))
{
	ran = Math.random() *9999;
	sho = ran;
	fr.document.getElementById('toptext').innerHTML = '<div><img width=0 height=5></div><table class=blue cellpadding=0 cellspacing=1 width=95% align=center><tr><td class=bluetop width=240><table cellpadding=0 cellspacing=0><tr><td class=gal><table cellspacing=0 cellpadding=0 width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td><b>Имеющийся товар</b></td></tr></table></td><td class=bluetop><table cellpadding=0 cellspacing=0><tr><td class=gal><table cellspacing=0 cellpadding=0 width=100% height=1><tr><td></td></tr></table><img src=/assets/img/mbarf.gif width=11 height=10 border=0></td><td><b>'+text+'</b></td></tr></table></td></tr><tr><td class=mainb height=265 bgcolor=FFFFFF valign=top><iframe src="/frames/iframe.php?ran='+ran+'" name="iframe" id="iframe" width="240" height="265" marginwidth="0" marginheight="0" frameborder="0" style="background-color: #AAAAAA;"></iframe></td><td class=mainb height=265 bgcolor=FFFFFF valign=top>'+menu+'</td></tr></table>';
}
}
...
function shoppager(page,maxpage,sh,show_specif)
{
	p = '';
...
if (fr)
	if (fr.document.getElementById('upmenutext'))
	{
		if (fr.document.getElementById('upimg'))
			...
			{
				fr.document.getElementById('upimg').innerHTML = '&nbsp;<img src=/assets/img/game/att.gif>';
...
if (fr.document.getElementById('map'))
{
	...
	if (isinfo == 1)
		imap = '<td width=18 align=center><a href=# onclick="javascript:Room=window.open(\'room.php?id='+id+'\', \'Room\', \'width=\'+500+\',height=\'+300+\', toolbar=0,location=0,status=0,scrollbars=0,resizable=0,left=100,top=100\');"><img  src=/assets/img/game/more.gif width=15 height=15 alt="Просмотреть описание"></a></td>';
	else
		imap = '';
	if (build == 1)
		ibuild = '<td width=18 align=center><img  src=/assets/img/game/house.gif width=16 height=15 alt="Жилой район. Разрешена постройка домов."></td>';
	else if (build == 2)
		ibuild = '<td width=18 align=center><img  src=/assets/img/game/house.gif width=16 height=15 alt="Палатки. Разрешена постройка магазинов."></td>';
	else
		ibuild = '';

	if (save == 1)
		isave = '<td width=18 align=center><img  src=/assets/img/game/def.gif width=15 height=15 alt="Защитная зона города"></td>';
	else
		isave = '';
	...
	let html = `
		<table width=100% height=170 cellspacing=0 style=cursor:hand cellpadding=0>
			<tr bgcolor=EBF1F7 align=center>
				<td width=33% height=33% ` + ((mapLocations[0][0]['id'] == 0 || mapLocations[0][0]['name'] == '') ? 'bgcolor=B9B9B9 ' : '') + `onclick=parent.gomap("1");>` + mapLocations[0][0]['name'] + `</td>
				<td width=1 bgcolor=8C9AAD></td>
				<td ` + ((mapLocations[0][1]['id'] == 0 || mapLocations[0][1]['name'] == '') ? 'bgcolor=B9B9B9 ' : '') + `onclick=parent.gomap("2");>` + mapLocations[0][1]['name'] + `</td>
				<td width=1 bgcolor=8C9AAD></td>
				<td width=33% ` + ((mapLocations[0][2]['id'] == 0 || mapLocations[0][2]['name'] == '') ? 'bgcolor=B9B9B9 ' : '') + `onclick=parent.gomap("3");>` + mapLocations[0][2]['name'] + `</td>
			</tr>
			<tr><td colspan=5 bgcolor=8C9AAD height=1></td></tr>
			<tr bgcolor=EBF1F7 align=center>
				<td ` + ((mapLocations[1][0]['id'] == 0 || mapLocations[1][0]['name'] == '') ? 'bgcolor=B9B9B9 ' : '') + `onclick=parent.gomap("4");>` + mapLocations[1][0]['name'] + `</td>
				<td width=1 bgcolor=8C9AAD>`;

	if (mapLocations[1][1]['img'] != '') {
		html +=	`</td><td bgcolor=B8C7D8 background=/assets/img/map/` + mapLocations[1][1]['img'] + ` class=map></td>`;
	} else {
		html +=	`</td><td bgcolor=B8C7D8 class=map>` + mapLocations[1][1]['name'] + `</td>`;
	}
	html +=		`<td width=1 bgcolor=8C9AAD>
				<td ` + ((mapLocations[1][2]['id'] == 0 || mapLocations[1][2]['name'] == '') ? 'bgcolor=B9B9B9 ' : '') + `onclick=parent.gomap("5");>` + mapLocations[1][2]['name'] + `</td>
			</tr>
			<tr><td colspan=5 bgcolor=8C9AAD height=1></td></tr>
			<tr bgcolor=EBF1F7 align=center>
				<td height=33% ` + ((mapLocations[2][0]['id'] == 0 || mapLocations[2][0]['name'] == '') ? 'bgcolor=B9B9B9 ' : '') + `onclick=parent.gomap("6");>` + mapLocations[2][0]['name'] + `</td>
				<td width=1 bgcolor=8C9AAD>
				<td ` + ((mapLocations[2][1]['id'] == 0 || mapLocations[2][1]['name'] == '') ? 'bgcolor=B9B9B9 ' : '') + `onclick=parent.gomap("7");>` + mapLocations[2][1]['name'] + `</td>
				<td width=1 bgcolor=8C9AAD>
				<td ` + ((mapLocations[2][2]['id'] == 0 || mapLocations[2][2]['name'] == '') ? 'bgcolor=B9B9B9 ' : '') + `onclick=parent.gomap("8");>` + mapLocations[2][2]['name'] + `</td>
			</tr>
		</table>`;
	fr.document.getElementById('map').innerHTML = html;
	if (went == 1)
