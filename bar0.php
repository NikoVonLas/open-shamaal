...
<input type=\"text\" name=\"ebar\" size=\"35\" style=\"max-width:500px;\" maxlength=\"250\" class=\"enter\" id=ebar autocomplete=\"off\" /  onkeydown=\"if (event.keyCode == 13) { this.form.submit(); return false; }\"></td>\r\n\t\t\t\t\t\t\t<td><img src=\"/img/go.gif\" width=\"31\" height=\"19\" alt=\"Отправить сообщение\" onclick=\"document.F.submit();\" style=\"cursor:hand\"><img src=\"/img/err.gif\" width=\"31\" height=\"19\" alt=\"Удалить текст чата\" onclick=\"top.clearchat();\" style=\"cursor:hand\"><img src=\"/img/attack.gif\" width=\"31\" height=\"1";
echo "9\" alt=\"Перейти в список боевых действий\" onclick=top.gotoskills(0); style=cursor:hand>";
print "{$sl}";
echo "<img src=\"/img/trade.gif\" width=\"31\" height=\"19\" alt=\"Передача вещей\" onclick=\"top.frames['menu'].document.location = 'menu.php?load=trade&action=addtrade';\" style=cursor:hand></td>\r\n\t\t\t\t\t\t\t<td width=100% id=clock align=right></td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\r\n\t\t\t\t\t\t</table>\r\n\r\n\t\t\t\t\t</td>\r\n\t\t\t\t</tr>\r\n\t\t\t</table>\r\n\t\t</td>\r\n\t</tr>\r\n\t</form>\r\n</table>\r\n";
