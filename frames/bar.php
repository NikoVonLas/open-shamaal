                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table cellspacing="0" cellpadding="0" width="100%">
                                            <tr>
                                                <td>
                                                    <img src="/img/ct.gif" width="20" height="19" alt="Канал города" style="cursor:hand" onclick="top.textenter('/город');">
                                                    <img src="/img/cl.gif" width="20" height="19" alt="Канал клана" onclick="top.textenter('/клан');" style="cursor:hand">
                                                    <img src="/img/to.gif" width="20" height="19" alt="Общий канал" onclick="top.textenter('/общий');" style="cursor:hand">
                                                    <img src="/img/gr.gif" width="20" onclick="top.textenter('/группа');" height="19" alt="Канал группы" " style="cursor:hand">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <img src="/img/err.gif" width="31" height="19" alt="Удалить текст чата" onclick="top.clearchat();" style="cursor:hand">
                                                    <img src="/img/attack.gif" width="31" height="19" alt="Перейти в список боевых действий" onclick="top.gotoskills(0);" style="cursor:hand">
                                                    {$sl} 
                                                    <img src="/img/trade.gif" width="31" height="19" alt="Передача вещей" onclick="top.frames['menu'].document.location = 'menu.php?load=trade&action=addtrade';" style="cursor:hand">
                                                </td>
