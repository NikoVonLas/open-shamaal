...
{
	global $GLOBAL_SKILL, $page,$pages_return,$id,$lt,$info_obj_obj,$info_obj_num,$info_obj_name,$info_canon,$info_obj,$info_obj_id,$info_obj_active,$info_obj_type,$info_obj_place,$info_obj_pic,$cur_weight,$race_str,$race_dex,$race_int,$race_wis,$race_con,$race,$str,$dex,$int,$wis,$con,$load,$do,$show, $show_specif,$result,$cbuy,$trade_id,$stg;
		...
		while ($row_num){
			...
			if (($info_obj_active[$i] == 0) && ($showlike == 1))
			{
				...
				if ($link == 'useobj')
				$ub = "<a href=/menu.php?load=delobj&id=$info_obj_id[$i] target=menu><img src=/assets/img/stuff/else/del.gif></a>";
				//$b = "<input type=text name=count value=1 maxlenght=5 style=width:35><img width=4><input type=submit value=» style=width:20>";
				...
				if ((($info_obj_specif[$i] == 5)||($info_obj_specif[$i] == 6)||($info_obj_specif[$i] == 8)||($info_obj_specif[$i] >= 10)||($info_obj_specif[$i] == 9) ||($info_obj_specif[$i] == 7)|| ($info_obj_specif[$i] == 0)) && ($link <> ""))
					$info_obj[$i] = "$debug<table cellpadding=0 cellspacing=0 $tabclass><tr><td id=objfull$info_obj_id[$i]><table width=218 cellspacing=1><tr><td colspan=2 align=center><b>$info_obj_name[$i] $ub</b></td></tr><tr bgcolor=F7FBFF><td align=center width=70><table cellpadding=0 cellspacing=0 width=64 height=70 background=/assets/img/game/b4slot.gif ><tr><td align=center><a href=/menu.php?load=$link&finv=1&obj_id=$info_obj_id[$i] target=menu><img src=/assets/img/stuff/$info_obj_pic[$i] border=0></a></td></tr></table></td><td valign=top>$info</td></tr></table></td></tr></table>";
				else
					if ($buy <> ""){
					 $spage = $page+1;
						$info_obj[$i] = "<table cellpadding=0 cellspacing=0><tr><td id=objfull$info_obj_id[$i]><form action=/menu.php target=menu name=objfull$info_obj_id[$i] id=objfull$info_obj_id[$i]><table width=218 cellspacing=1><input type=hidden name=obj_id value=$info_obj_id[$i]><input type=hidden name=id value=$id><input type=hidden name=show value=$show><input type=hidden name=show_specif value=$show_specif><input type=hidden name=do value=$do><input type=hidden $buy><input type=hidden name=page value=$spage><input type=hidden name=load value=$load><input type=hidden name=trade_id value=$trade_id><input type=hidden name=stg value=1><tr><td colspan=2 align=center><b>$info_obj_name[$i] $ub</b></td></tr><tr bgcolor=F7FBFF><td align=center width=70><table cellpadding=0 cellspacing=0 width=64 height=70 background=/assets/img/game/b4slot.gif ><tr><td align=center><img src=/assets/img/stuff/$info_obj_pic[$i] border=0><br></td></tr></table>$b</td><td valign=top>$info</td></tr></table></form></td></tr></table>";
					}else
						$info_obj[$i] = "$debug<table cellpadding=0 cellspacing=0 $tabclass><tr><td id=objfull$info_obj_id[$i]><table width=218 cellspacing=1><tr><td colspan=2 align=center><b>$info_obj_name[$i] $ub</b></td></tr><tr bgcolor=F7FBFF><td align=center width=70><table cellpadding=0 cellspacing=0 width=64 height=70 background=/assets/img/game/b4slot.gif ><tr><td align=center><img src=/assets/img/stuff/$info_obj_pic[$i] border=0><br></td></tr></table>$b</td><td valign=top>$info</td></tr></table></td></tr></table>";
			}
			else
			{
				$place = $info_obj_place[$i];
