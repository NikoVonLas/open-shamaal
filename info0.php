...
echo "</font></b></td><td width=35 align=left><a href=menu.php?load=exit target=menu><img src=\"/img/exit.gif\" width=\"32\" height=\"18\"  alt=\"Выход из игры\"></a></td></tr></table>\r\n\t</td>\r\n</tr>\r\n</table>\r\n<table class=blue cellpadding=0 cellspacing=1 width=100% height=330>\r\n\t<tr>\r\n\t\t<td class=bluetop>\r\n\t\t\t<table cellpadding=0 cellspacing=0>\r\n\t\t\t\t<tr>\r\n\t\t\t\t\t<td class=gal>\r\n\t\t\t\t\t\t<table cellspacing=\"0\" cellpadding=\"0\" width=100";
...
echo "\t\t\t\t\t\t<img src=/img/mbarf.gif width=11 height=10 border=0 alt='Здесь отображается вся информация о состоянии вашего персонажа.'>\r\n\t\t\t\t\t</td>\r\n\t\t\t\t\t<td>\r\n\t\t\t\t\t\tСостояние персонажа\r\n\t\t\t\t\t</td>\r\n\t\t\t\t</tr>\r\n\t\t\t</table>\r\n\t\t</td>\r\n\t</tr>\r\n\t<tr>\r\n\t\t<td class=mainb height=60>\t\r\n\t\t\t<table cellpadding=0 cellspacing=0 align=\"center\" width=98%>\r\n\t\t\t<tr>\r\n\t\t\t\t<td class=\"har\" width=\"25\">Жизни</td>\r\n\t\t\t\t<td align=center width=1";
echo "20><img src=/img/game/HPl.gif width=7 height=12><img src=/img/game/HP1.gif width=";
print $per_hp;
echo " height=12 id=hp1><img src=/img/game/HP.gif width=";
print $per_ahp;
echo " height=12 id=hp2><img src=/img/game/HPr.gif width=7 height=12></td>\r\n\t\t\t\t<td class=\"har\" id=\"hpscore\">";
print $chp."/".$player_max_hp;
echo "</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr><td colspan=3 height=2></td></tr>\r\n\t\t\t<tr>\r\n\t\t\t\t<td class=\"har\">Энергия</td>\r\n\t\t\t\t<td align=center width=120><img src=/img/game/HPl.gif width=7 height=12><img src=/img/game/HP3.gif width=";
print $per_mana;
echo " height=12 id=mana1><img src=/img/game/HP.gif width=";
print $per_amana;
echo " height=12 id=mana2><img src=/img/game/HPr.gif width=7 height=12></td>\r\n\t\t\t\t<td class=\"har\" id=\"manascore\">";
print $cmana."/".$player_max_mana;
echo "</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr><td colspan=3 height=2></td></tr>\r\n\t\t\t<tr>\r\n\t\t\t\t<td class=\"har\">Баланс</td>\r\n\t\t\t\t<td align=center width=120><img src=/img/game/HPl.gif width=7 height=12><img src=/img/game/HP2.gif width=1 height=12 id=bal1><img src=/img/game/HP.gif width=99 height=12 id=bal2><img src=/img/game/HPr.gif width=7 height=12></td>\r\n\t\t\t\t<td class=\"har\" id=bal>Есть</td>\r\n\t\t\t</tr>\r\n\t\t\t<tr><td colspan=3 height=2></td></tr>\r\n\t";
echo "\t\t<tr>\r\n\t\t\t\t<td class=\"har\">Эликсиры</td>\r\n\t\t\t\t<td align=center width=120><img src=/img/game/HPl.gif width=7 height=12><img src=/img/game/HP2.gif width=1 height=12 id=dbal1><img src=/img/game/HP.gif width=99 height=12 id=dbal2><img src=/img/game/HPr.gif width=7 height=12></td>\r\n\t\t\t\t<td class=\"har\" id=dbal>Есть</td>\r\n\t\t\t</tr>\r\n\t\t\t</table>\r\n\r\n\t\t</td>\r\n\t</tr>\r\n\t<tr>\r\n\t\t<td class=bluetop>\r\n\t\t\t<table cellpadding=0 cellspaci";
