...
talk.noty({
		text     : '<div ><img src="/img/'+img+'" alt="'+title+'" title="'+title+'" style="float: left;padding-bottom:10px;"/> <strong>'+title+'</strong> <br />'+texto+'</div>',
		layout   : 'bottomRight',
		timeout: 15000,
		maxVisible: 2,
		closeWith: ['click']
...
if (top.frames['mtop'].document.getElementById('toptext'))
{
    ...
    if (h_up > 0)
		...
		up = '';
    if (h_down > 0)
    	down = '<img src=/img/game/down.gif border=0 width=8 height=8>';
    else
    	down = '';
	if (city_rank != "")
...
if (top.frames['mtop'].document.getElementById('toptext'))
{
	...
	sbody = start+bodyid+' target=menu><img src=/img/stuff/'+body+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+bodytext+'");></a>';
	ssword = start+swordid+' target=menu><img src=/img/stuff/'+sword+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+swordtext+'");></a>';
	sglove = start+gloveid+' target=menu><img src=/img/stuff/'+glove+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+glovetext+'");></a>';
	shelmet = start+helmetid+' target=menu><img src=/img/stuff/'+helmet+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+helmettext+'");></a>';
	scloak = start+cloakid+' target=menu><img src=/img/stuff/'+cloak+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+cloaktext+'");></a>';
	sshield = start+shieldid+' target=menu><img src=/img/stuff/'+shield+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+shieldtext+'");></a>';
	slegs = start+legsid+' target=menu><img src=/img/stuff/'+legs+' onmouseout=hide_info(this);  onmouseover=tooltip(this,"'+legstext+'");></a>';
	img = '<table cellpadding=0 cellspacing=0 width=280><tr><td background=/img/game/b2slot.gif width=64 height=32 align=center>'+samulet+'</td><td rowspan=5 width=150 align=center><img src=/img/obraz/'+pic+'></td><td rowspan=2 background=/img/game/bslot.gif  width=64  height=64 align=center>'+shelmet+'</td></tr><tr><td  height=32><table width=100% height=100% cellpadding=0 cellspacing=0><tr><td background=/img/game/b3slot.gif align=center width=32>'+sring1+'</td><td  background=/img/game/b3slot.gif align=center>'+sring2+'</td></tr></table></td></tr><tr><td background=/img/game/b4slot.gif height=70 align=center>'+sbody+'</td><td background=/img/game/b4slot.gif  height=70 align=center>'+scloak+'</td></tr><tr><td background=/img/game/b4slot.gif  height=70 align=center>'+ssword+'</td><td background=/img/game/b4slot.gif  height=70 align=center>'+sshield+'</td></tr><tr><td background=/img/game/bslot.gif  height=64 align=center>'+sglove+'</td><td background=/img/game/bslot.gif  height=64 align=center>'+slegs+'</td></tr></table>';
...
if (fr.document.getElementById('toptext'))
{
	...
	if (per != 0)
		...
		cit = '';
	fr.document.getElementById('toptext').innerHTML = '<div><img width=0 height=5></div><table class=blue cellpadding=0 cellspacing=1 width=95% align=center><tr><td class=bluetop width=34%><table cellpadding=0 cellspacing=0><tr><td class=gal><table cellspacing=0 cellpadding=0 width=100% height=1><tr><td></td></tr></table><img src=/img/mbarf.gif width=11 height=10 border=0></td><td><b>Имеющийся товар</b></td></tr></table></td><td class=bluetop><table cellpadding=0 cellspacing=0><tr><td class=gal><table cellspacing=0 cellpadding=0 width=100% height=1><tr><td></td></tr></table><img src=/img/mbarf.gif width=11 height=10 border=0></td><td><b>'+text+'</b></td></tr></table></td></tr><tr><td class=mainb height=265 bgcolor=FFFFFF valign=top><table width=80% align=center height=80%><tr><td valign=top>'+menu+'</td></tr></table><table width=90% align=center><tr><td align=center>'+cit+'</td></tr></table></td><td class=mainb height=265 bgcolor=FFFFFF valign=top><iframe src=iframe.php?ran='+ran+' name=iframe'+sho+'  id=iframe'+sho+'  width=100% height=100% marginwidth=2 marginheight=2 frameborder=0></iframe></td></tr></table>';
...
if (fr.document.getElementById('map'))
{
	...
	if (isinfo == 1)
		imap = '<td width=18 align=center><a href=# onclick="javascript:Room=window.open(\'room.php?id='+id+'\', \'Room\', \'width=\'+500+\',height=\'+300+\', toolbar=0,location=0,status=0,scrollbars=0,resizable=0,left=100,top=100\');"><img  src=/img/game/more.gif width=15 height=15 alt="Просмотреть описание"></a></td>';
	else
		imap = '';
	if (build == 1)
		ibuild = '<td width=18 align=center><img  src=/img/game/house.gif width=16 height=15 alt="Жилой район. Разрешена постройка домов."></td>';
	else if (build == 2)
		ibuild = '<td width=18 align=center><img  src=/img/game/house.gif width=16 height=15 alt="Палатки. Разрешена постройка магазинов."></td>';
	else
		ibuild = '';

	if (save == 1)
		isave = '<td width=18 align=center><img  src=/img/game/def.gif width=15 height=15 alt="Защитная зона города"></td>';
	else
		isave = '';
	...
	if (mapLocations[1][1]['img'] != '') {
		html +=	`</td><td bgcolor=B8C7D8 background=/img/map/` + mapLocations[1][1]['img'] + ` class=map></td>`;
	} else {
