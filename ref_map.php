...
while ($row_num) {
    $locations = array(
        array(
            array(
                'id' 	=> $row_num[3],
                'name' 	=> str_replace('"', '\"', $row_num[4])
            ),
            array(
                'id' 	=> $row_num[5],
                'name' 	=> str_replace('"', '\"', $row_num[6])
            ),
            array(
                'id' 	=> $row_num[7],
                'name' 	=> str_replace('"', '\"', $row_num[8])
            ),
        ),
        array(
            array(
                'id' 	=> $row_num[9],
                'name' 	=> str_replace('"', '\"', $row_num[10])
            ),
            array(
                'id' 		=> $row_num[3],
                'name' 		=> str_replace('"', '\"', $row_num[0]),
                'location'	=> str_replace('"', '\"', $row_num[1]),
                'img'		=> $row_num[2],
                'trap'		=> $row_num[19],
                'no_pvp'	=> $row_num[20],
                'regen'		=> $row_num[21],
            ...
            array(
                'id' 	=> $row_num[11],
                'name' 	=> str_replace('"', '\"', $row_num[12])
            ),
        ),
        array(
            array(
                'id' 	=> $row_num[13],
                'name' 	=> str_replace('"', '\"', $row_num[14])
            ),
            array(
                'id' 	=> $row_num[15],
                'name' 	=> str_replace('"', '\"', $row_num[16])
            ),
            array(
                'id' 	=> $row_num[17],
                'name' 	=> str_replace('"', '\"', $row_num[18])
            ),
        ),
    );
    $m_name = $row_num[0];
