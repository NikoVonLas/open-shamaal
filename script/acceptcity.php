...
print "<html><head><meta content=\"text/html; charset=utf-8\" http-equiv=\"Content-Type\"></head><LINK REL=STYLESHEET TYPE=\"TEXT/CSS\" HREF=\"../style.css\" TITLE=\"STYLE\"><title>Правительство города {$city_name}</title>";
if ( !isset( $city_id ) )
{
    sql_disconnect( );
    exit( );
