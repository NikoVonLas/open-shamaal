...
while ( $row_num )
{
    ...
    if ( $city_rank == 1 )
    {
        $info .= "<form action=poscity.php method=post><input type=hidden name=rank_id value={$rank_id}><input type=hidden name=load value={$load}><input type=hidden name=action value={$action}><input type=hidden name=do value=saverank><tr bgcolor=F7FBFF><td  align=center><a href=poscity.php?load={$load}&action={$action}&do=del&rank_id={$rank_id}><img src=/img/game/del.gif></a></td><td  align=center ><input type=text name=c_name value=\"{$rank_name}\" size=14></td><td    align=center><input type=checkbox name=s_opt1 value=1 {$rop1} class=rad></td><td     align=center><input type=checkbox name=s_opt2 value=1 {$rop2} class=rad></td><td     align=center><input type=checkbox name=s_opt3 value=1 {$rop3} class=rad></td><td   align=center><input type=checkbox name=s_opt4 value=1 {$rop4}  class=rad></td><td   align=center><input type=checkbox name=s_opt5 value=1 {$rop5} class=rad></td><td align=center><input type=submit value=Изменить style=width:60></td></tr></form>";
    }
    else
    {
