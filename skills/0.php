...
$game_skill_name[0][3] = "Бросить сосульку";
$game_skill_dmg[0][3] = -10;
$game_skill_textnum[0][3] = 4;
$game_skill_text[0][3][1] = "[<b>{$target_name}</b>, жизни <font class=dmg><DMG></font>]&nbsp;<b>{$player_name} </b>silno бросил{$sex_a} сосульку {$v_mesto[$kickto]} {$sopernika2}.";
$game_skill_text[0][3][2] = "[<b>{$target_name}</b>, жизни <font class=dmg><DMG></font>]&nbsp;<b>{$player_name} </b>размахнул{$las} и silno швырнул{$sex_a} сосульку {$v_mesto[$kickto]} {$sopernika2}.";
$game_skill_text[0][3][3] = "[<b>{$target_name}</b>, жизни <font class=dmg><DMG></font>]&nbsp;<b>{$player_name} </b>с разбегу silno метнул{$sex_a} сосулькой {$po_mestu[$kickto]} {$sopernika2}.";
$game_skill_text[0][3][4] = "[<b>{$target_name}</b>, жизни <font class=dmg><DMG></font>]&nbsp;<b>{$player_name} </b>неожиданно silno кинул{$sex_a} сосульку прямо {$v_mesto[$kickto]} {$sopernika2}.";
$game_skill_block[0][3] = "[<b>{$target_name}</b>]&nbsp;<b>{$player_name} </b>швырял{$sex_a} сосульку {$v_mesto[$kickto]}, но {$target_name} поставил{$sex2_a} <b>блок</b>.";
$game_skill_miss[0][3] = "[<b>{$target_name}</b>]&nbsp;<b>{$player_name} </b>запускал{$sex_a} сосульку {$v_mesto[$kickto]}, но {$target_name} <b>увернул{$las2} </b> от неё.";
$game_skill_dmgtype[0][3] = 999;  // На него не влияют защиты, а по НПЦ со слабостью он усиливается в 10 раз (сделать потом, а пока хватит и захардкодить снеговиков)
$game_skill_canblock[0][3] = 1;
$game_skill_wepon[0][3] = 6;
$game_skill_canmiss[0][3] = 1;
$game_skill_bad[0][3] = 1;
$game_skill_same_room[0][3] = 1;
$game_skill_type[0][3] = 1;
$game_skill_percent[0][3] = 0;
