...
$game_skill_text[21][3][1] = "[<b>$target_name</b>, жизни <font class=dmg><DMG></font>]&nbsp;<b>$player_name </b>произнес$sex_la заклинание <font class=atype>`Сильное Лечение`</font>.";
$game_skill_text[21][3][2] = "[<b>$target_name</b>, жизни <font class=dmg><DMG></font>]&nbsp;<b>$player_name </b>выполнил$sex_a заклинание <font class=atype>`Сильное Лечение`</font>.";
$game_skill_miss[21][3] = "[<b>$target_name</b>]&nbsp;<b>$player_name </b>выполнил$sex_a заклинание <font class=atype>`Сильное Лечение`</font>, но $target_name смог$sex2_la увернуться от магии.";
