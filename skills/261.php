...
$game_skill_name[26][3] = "Прокалывание";
$game_skill_dmg[26][3] = $wis_dmg * 1.5;
$game_skill_count[26][3] = 1;
$game_skill_mana[26][3] = 70;
$game_skill_textnum[26][3] = 1;
$game_skill_text[26][3][1] = "[<b>{$target_name}</b>, жизни <font class=dmg><DMG></font>]&nbsp;<b>{$player_name} </b> дважды проколол{$sex_a} куклу Voodoo острой иглой.";
